#!/usr/bin/env python3
"""Generator for `preview-product-boundary-successor.v14.json`.
...
SELF = "preview-product-boundary-successor.v14"
SPEAKER = f"This {SELF}"
VERSION = 14
REQUIRED_NOW = 28
REGISTER_ROW = "DR-117"
        ...
        "findingDisposition": [{
            ...
            {"id": fid, "severity": "LANDED",
             ...
             "disposition": f"landed at {SELF}: " + (
                 ...
                 or V13_DISPOSITIONS.get(fid) or HISTORICAL_DISPOSITIONS.get(fid) or "")}
...
def main(argv=None):
    ...
    try:
        ...
        print(f"make-ppbs-v14.py: FAILED: {e}", file=sys.stderr)
        return 2
    except subprocess.CalledProcessError as e:
        print(f"make-ppbs-v14.py: FAILED: git: {e}", file=sys.stderr)
        return 2
