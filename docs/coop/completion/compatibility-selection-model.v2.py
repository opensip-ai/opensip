...
equivalent pinned environment. Version 2 repairs review finding COMP2-M1.
"""
...
def run(args):
    cases_path = HERE / 'compatibility-selection-cases.v2.json'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--report', default=str(HERE / 'compatibility-selection-report.v2.json'))
