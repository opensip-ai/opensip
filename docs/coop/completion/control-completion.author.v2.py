...
(HERE/'control-completion.schema.v3.json').write_text(json.dumps(schema,indent=2)+'\n')
...
(HERE/'control-completion.cases.v2.json').write_text(json.dumps(corpus,indent=2,ensure_ascii=False)+'\n');print('Authored',len(cases),'control cases')
