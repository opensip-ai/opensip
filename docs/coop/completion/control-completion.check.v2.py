...
def main():
 ap=argparse.ArgumentParser(description=__doc__);ap.add_argument('--report',default=str(HERE/'control-completion.report.v2.json'));args=ap.parse_args()
 cases_path=HERE/'control-completion.cases.v2.json';corpus=json.loads(cases_path.read_text());results=[]
