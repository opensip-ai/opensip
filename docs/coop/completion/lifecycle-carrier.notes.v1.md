# Lifecycle SQLite carrier, proposed version 1
...
```sh
python3 docs/coop/completion/lifecycle-carrier.check.v1.py --report /tmp/lifecycle-carrier-replay.json
```
...
contracts and filesystem ordering are in `lifecycle-carrier.contract.v1.json`.
