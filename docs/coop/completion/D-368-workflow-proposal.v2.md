...
1. The author supplies a concrete contract or decision, source references,
   ...
   a digest-pinned passing report at recording. Each reviewed unit has exactly
...
4. All unresolved MUST-FIX and SHOULD-FIX findings prevent adoption. Three
   ...
   both positions and verdicts, and cited authority. Its retained digest-pinned
   ...
   either party's assent. New defects, if discovered, are recorded separately
