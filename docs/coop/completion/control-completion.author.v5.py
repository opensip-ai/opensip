...
# Exact independent v4 probe bytes retained, with identity UTF8 regression coverage.
cases.extend([{'id': 'REVIEW-v4/surrogate-stable-id', 'messageType': 'hello', 'context': {'state': 'AWAIT-HELLO', 'direction': 'host-to-component', 'helloSeen': False, 'frameBound': 65536, 'frameOffer': 65536, 'nextSeq': 1, 'stableId': '00000000-0000-4000-8000-000000000001', 'manifestDigest': '1111111111111111111111111111111111111111111111111111111111111111', 'platform': {'os': 'linux', 'arch': 'x86_64'}, 'manifestTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'offeredTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'confirmedTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'selectedTuple': {'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}, 'pendingNonce': {'pong': 'nonce-1', 'healthReport': 'nonce-1'}, 'authorizationEvidence': {'authorized': True, 'effectClass': 'HE-1', 'authorizationRef': 'opaque-grant-record-fixture', 'operationRef': 'opaque-operation-fixture', 'decisionClass': None, 'bindingMismatchDecisionClass': 'PR-4'}, 'effectOutcomeEvidence': {'requestSeq': 12, 'decisionSeq': 40, 'outcomeSeq': 41, 'commitClass': 'REVERSIBLE', 'effectOutcome': 'COMPLETED', 'effectClass': 'HE-1'}}, 'frameHex': '', 'expected': {'verdict': 'ACCEPT', 'type': 'hello', 'nextState': 'AWAIT-HELLO-ACK', 'bodyBuffered': True}}, {'id': 'REVIEW-v4/overlong-digest', 'messageType': 'hello', 'context': {'state': 'AWAIT-HELLO', 'direction': 'host-to-component', 'helloSeen': False, 'frameBound': 65536, 'frameOffer': 65536, 'nextSeq': 1, 'stableId': '00000000-0000-4000-8000-000000000001', 'manifestDigest': '1111111111111111111111111111111111111111111111111111111111111111', 'platform': {'os': 'linux', 'arch': 'x86_64'}, 'manifestTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'offeredTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'confirmedTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'selectedTuple': {'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}, 'pendingNonce': {'pong': 'nonce-1', 'healthReport': 'nonce-1'}, 'authorizationEvidence': {'authorized': True, 'effectClass': 'HE-1', 'authorizationRef': 'opaque-grant-record-fixture', 'operationRef': 'opaque-operation-fixture', 'decisionClass': None, 'bindingMismatchDecisionClass': 'PR-4'}, 'effectOutcomeEvidence': {'requestSeq': 12, 'decisionSeq': 40, 'outcomeSeq': 41, 'commitClass': 'REVERSIBLE', 'effectOutcome': 'COMPLETED', 'effectClass': 'HE-1'}}, 'frameHex': '', 'expected': {'verdict': 'ACCEPT', 'type': 'hello', 'nextState': 'AWAIT-HELLO-ACK', 'bodyBuffered': True}}, {'id': 'REVIEW-v4/overlong-stable-id', 'messageType': 'hello', 'context': {'state': 'AWAIT-HELLO', 'direction': 'host-to-component', 'helloSeen': False, 'frameBound': 65536, 'frameOffer': 65536, 'nextSeq': 1, 'stableId': '00000000-0000-4000-8000-000000000001', 'manifestDigest': '1111111111111111111111111111111111111111111111111111111111111111', 'platform': {'os': 'linux', 'arch': 'x86_64'}, 'manifestTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'offeredTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'confirmedTuples': [{'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}], 'selectedTuple': {'role': 'analyzer', 'roleSubprotocol': 'typescript', 'subprotocolVersion': 1}, 'pendingNonce': {'pong': 'nonce-1', 'healthReport': 'nonce-1'}, 'authorizationEvidence': {'authorized': True, 'effectClass': 'HE-1', 'authorizationRef': 'opaque-grant-record-fixture', 'operationRef': 'opaque-operation-fixture', 'decisionClass': None, 'bindingMismatchDecisionClass': 'PR-4'}, 'effectOutcomeEvidence': {'requestSeq': 12, 'decisionSeq': 40, 'outcomeSeq': 41, 'commitClass': 'REVERSIBLE', 'effectOutcome': 'COMPLETED', 'effectClass': 'HE-1'}}, 'frameHex': '', 'expected': {'verdict': 'ACCEPT', 'type': 'hello', 'nextState': 'AWAIT-HELLO-ACK', 'bodyBuffered': True}}])
for retained_case in cases:
 if retained_case['id'].startswith('REVIEW-v4/'):
  retained_case['expected']={'verdict':'RF-2','nextState':'FAULTED','bodyBuffered':True}
for t in ['hello','helloAck']:
 ctx={'state':'AWAIT-HELLO' if t=='hello' else 'AWAIT-HELLO-ACK','direction':'host-to-component' if t=='hello' else 'component-to-host','helloSeen':False}
 for field in [('expectedStableId' if t=='hello' else 'stableId'),'admittedManifestDigest']:
  for label,value in [('surrogate','\ud800'),('overlong','a'*1025)]:
   for seq in [1,0,9007199254740992]:
    value_frame=envelope(t,{**body[t],field:value},seq=seq)
    raw=json.dumps(value_frame,separators=(',',':'),ensure_ascii=True).encode('utf-8')
    add('IDENTITY-UTF8/'+t+'/'+field+'/'+label+'/seq-'+str(seq),t,'RF-2',ctx,raw=len(raw).to_bytes(4,'big')+raw)
...
(HERE/'control-completion.cases.v5.json').write_text(json.dumps(corpus,indent=2,ensure_ascii=False)+'\n');print('Authored',len(cases),'control cases')
