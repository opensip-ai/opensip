...
S=json.loads((B/'g13-result-schema.v3.json').read_text())
...
def reference():
    ...
    for platform in M['platforms']:
        ...
        runner.update(runnerClass=CLASSES[platform][0],vcpu=CLASSES[platform][1],ramBytes=7000000000 if platform=='macos-arm64' else 14000000000 if platform=='macos-x86_64' else 16000000000,concurrency=1)
