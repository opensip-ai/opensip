...
- **Status:** **ADOPTED 2026-08-27.** Turn 1 of 3: CONSENT from
  ...
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-285.review-adversarial.codex.json`,
  `d73b32d15068df01723660c0714adaf9d852e72361d4a03cf7192ec4603471e3`)
  CONSENT. Subject `coordinator-decisions.D-285.draft.md`
  `f9893b5e64cacc6ae97587cc4f917ee9b8c8c56528b6df3614082f50b0ef6df3`.
  Frozen leftover-join `doctor-actor-leftover-join.v12.json`
  `0c0b894ffb5f80981282455a99153975e3fac30ade076d2596efb2b4fcf1a9e9`
  Stage A Claude ACCEPT
  `c8f52ac16154d7aea98fd716a6a92ee30767a5f483d2e1e4b643c0d014f040ec`
  0/0; Stage A Codex ACCEPT
  `42f5e26f89a0f258398d5259373a586039e03c11a784ac922a64d583110bef04`
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `doctor-actor-leftover-join.v12.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  ...
  D-267 and D-268 and D-269 and D-270 and D-271 and D-273 and
  D-274 and D-275 and D-276 and D-277 and D-278 and D-279 and
  D-280 and D-281 and D-282 and D-283 and D-284. D-272 is
  CONTESTED and is not on this no-cell-edit adoption branch. Not a
  three-limb act. Not SATISFIED-GRADE.
- **Subject:**
  `docs/coop/artifacts/doctor-actor-leftover-join.v12.json`
  `0c0b894ffb5f80981282455a99153975e3fac30ade076d2596efb2b4fcf1a9e9`.
- **Decision:** Record leftover-join.v12 as DR-114 leftover
  remasurement after D-284. The candidate binds NOTHING. DR-114
  stays `OPEN`. leftover-design of OBL-DOCTOR-FX-AUTHORING,
  OBL-JOIN-FX-AUTHORING, OBL-FC-C1, OBL-BLK-1, OBL-BLK-2,
  OBL-BLK-3, OBL-BLK-4 remains on leftover-join.v12.
  leftover-join.v11 remains current at draft time. After this
  successor is recorded, leftover-join.v11 is not current.  G12
  occupancy v6 is the current G12 occupancy remasurement (D-221).
  G21 occupancy v4 is the current G21 occupancy remasurement
  (D-218). G32 occupancy v3 is the current G32 occupancy
  remasurement (D-209). G12 occupancy v4 is not recorded as
  current occupancy. G21 occupancy v3 is not recorded as current
  occupancy. G32 occupancy v1 is not recorded as current
  occupancy. g12 leftover-join.v4 remains the current DR-G12 GATE
  leftover-join (D-258). g21 leftover-join.v12 remains the current
  DR-G21 GATE leftover-join (D-248). permission leftover-join.v12
  remains the current DR-105 ROW leftover-join (D-283). Remainder
  of OBL-JOIN-FX-EXECUTION is G32 execution. OBL-G12-HARNESS-SPEC,
  OBL-G21-HARNESS-SPEC, and OBL-G32-HARNESS-SPEC authoring remain
  measured closed against the current occupancies; execution
  remains qualification (D-056). Does not pin QUALIFIED. Does not
  invent fixture bytes. Does not invent pre-image, post-image, or
  report bytes, a decision-record envelope, a D9 code, or a
  section 7.1 recipe. Does not record FC-C1. Does not admit CA-1
  IN_PROCESS or mint the later CA-2 gate. Does not mint a D-096
  (A) grant. Does not force a ride onto G09. Does not steal
  OBL-DOCTOR-FX-AUTHORING as a GATE closure. Does not steal
  OBL-G21-FX-AUTHORING, OBL-FX-AUTHORING, OBL-R10-AUTHORING, or
  OBL-R6-AUTHORING. Does not occupy the G12, G21, or G32
  identifiers. Does not SATISFY DR-114. Does not SATISFY DR-105.
  Does not SATISFY DR-117. Does not reopen DR-102 SATISFIED. Does
  not flatten DR-118 `DECIDED-V1-NOT-INTEGRATED` to `OPEN`. Does
  not flatten DR-107 `PROPOSED-CLOSED-FOR-REVIEW` to `OPEN`. Does
  not SATISFY DR-131. Does not SATISFY DR-133. Does not SATISFY
  DR-101. Gate 1 Class A is not opened. Not SATISFIED.
  Required-now stays 28. Condition-4 effect is zero. Naming parent
  of G12 and G21 is naming v6 (D-145); naming parent of G32 is
  join-fx-gate-naming.v2 (D-169); the naming parent is not
  leftover-join.v12. D-086 named DR-G12 and DR-G21. D-169 named
  DR-G32. Claude Stage A leftover-join.v12 returned 3 named
  observationsNotFindings objects CLAUDE-DALJ-V12-OBS1,
  CLAUDE-DALJ-V12-OBS2, CLAUDE-DALJ-V12-OBS3 (each with members
  id, observation); no change requested; they carry those
  identifiers. It returned no observations field and no advisories
  field. Codex Stage A leftover-join.v12 returned an empty
  observationsNotFindings list. It returned no observations field
  and zero advisories. This entry names those Claude identifiers.
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage A
  returned no observation identifiers. leftover-join.v12 lands no
  new finding and re-lands nothing. Its lands list is identical to
  leftover-join.v11's: CLAUDE-DALJ-V3-B1 (landed in this lineage
  at leftover-join.v4), CLAUDE-PTLJ-V3-SF1 (at leftover-join.v6),
  CLAUDE-DALJ-V7-SF1 (at leftover-join.v8). Its findingDisposition
  carries the same six identifiers as leftover-join.v11's, in the
  same order: CLAUDE-DALJ-V9-B1, DALJ-V9-B1, DALJ-V9-B2, and
  DALJ-V9-SF1 (landed at leftover-join.v10); CLAUDE-DALJ-V10-SF1
  and DALJ-V10-SF1 (landed at leftover-join.v11). Each of those
  six dispositions reads `ACCEPTED` in leftover-join.v11; in
  leftover-join.v12 the first four read `ACCEPTED. Landed in this
  lineage at leftover-join.v10. This v12 does not re-land it.` and
  the last two read `ACCEPTED. Landed in this lineage at
  leftover-join.v11. This v12 does not re-land it.`; no other
  findingDisposition member differs. leftover-join.v12 adds three
  top-level fields absent from leftover-join.v11, registerRowNote,
  landsNote, and parentReview; landsNote recites that cumulative
  landing record as carried unchanged from leftover-join.v11.
  basedOn.d284.role is last-heading custody only. Claude Stage B
  returned 5 named observationsNotFindings objects D285-ADV-O1,
  D285-ADV-O2, D285-ADV-O3, D285-ADV-O4, D285-ADV-O5 (each with
  members id, observation, whyNotAFinding); no change requested;
  they carry those identifiers. It returned an empty observations
  list and zero advisories. Codex Stage B returned an empty
  observationsNotFindings list. It returned no observations field
  and zero advisories. This entry names those Claude identifiers.
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage B
  returned no observation identifiers. Does not execute G12, G21,
  or G32. Does not rewrite G12 occupancy v6, G21 occupancy v4, or
  G32 occupancy v3. Does not edit file 08. Does not authorize
  `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D285. Does not unwrite D-032, D-035, D-086, D-163, D-164,
...
- **Status:** **ADOPTED 2026-08-27.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-287.review-adversarial.claude2.json`,
  `c11fe8e58e23379cf85434052f704ad9387cc59808d83eebeeb6fdd432cc1377`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-287.review-adversarial.codex.json`,
  `cfd94a47755877650e80459a048457f0d47b88ed577e83ea7eb04b59b9c427bc`)
  CONSENT. Subject `coordinator-decisions.D-287.draft.md`
  `fbd5a12cf3c680493eade691cf98a31ca3156e591ae76c9e2e1a4ffd8098249d`.
  Frozen leftover-join `distribution-core-leftover-join.v9.json`
  `e6b235d3330a03e62acede6770919a413791c958a3e791eca5f677e822100bc7`
  Stage A Claude ACCEPT
  `2484336ac0b998075d68a3ab91f1db3998cb2126ce59626243a73167036dcce2`
  0/0; Stage A Codex ACCEPT
  `2db8aed15262ad716768c7e6821062842bb2d8dea260868e021650ff45e7504b`
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `distribution-core-leftover-join.v9.json` (0 blockers,
  0 SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235
  and D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  D-255 and D-256 and D-257 and D-258 and D-259 and D-260 and
  D-261 and D-262 and D-263 and D-264 and D-265 and D-266 and
  ...
  D-286. D-272 is CONTESTED and is not on this no-cell-edit
  adoption branch. Not a three-limb act. Not SATISFIED-GRADE.
- **Subject:**
  `docs/coop/artifacts/distribution-core-leftover-join.v9.json`
  `e6b235d3330a03e62acede6770919a413791c958a3e791eca5f677e822100bc7`.
- **Decision:** Record leftover-join.v9 as DR-101 leftover
  remasurement after D-286. The candidate binds NOTHING. DR-101
  stays `OPEN`. leftover-design of OBL-2, OBL-D1, OBL-D2 remains
  on leftover-join.v9. leftover-join.v7 remains current at draft
  time. After this successor is recorded, leftover-join.v7 is not
  current. leftover-join.v8 is CANDIDATE-NOT-APPLIED (Split at
  Stage A: Codex ACCEPT 0/0; Claude REJECT 0/2 CLAUDE-DCLJ-V8-SF1
  / CLAUDE-DCLJ-V8-SF2, both landed at leftover-join.v9) and is
  not current. G01 occupancy v9 is the current G01 occupancy
  remasurement (D-231). G02 occupancy v4 is the current G02
  occupancy remasurement (D-232). G03 occupancy v5 is the current
  G03 occupancy remasurement (D-233). G04 occupancy v4 is the
  current G04 occupancy remasurement (D-234). G05 occupancy v4 is
  the current G05 occupancy remasurement (D-235). G01 occupancy v1
  is not recorded as current occupancy. G02 occupancy v1 is not
  recorded as current occupancy. G03 occupancy v4 is not recorded
  as current occupancy. G04 occupancy v1 is not recorded as
  current occupancy. G05 occupancy v1 is not recorded as current
  occupancy.  OBL-2 remains leftover-design on the D-006
  unit/accounting limb; OD-101-1 and OD-101-2 remain
  leftover-design; harness-spec authoring is measured closed
  against the current G01-G05 occupancy remasurements; execution
  remains qualification (D-056). Does not pin QUALIFIED. Does not
  invent fixture bytes. Does not invent a D-006 unit. Does not
  mint Rust-as-core. Does not decide OD-101-2. Does not invent
  G01-G05 harness specifications. Does not invent a D9 code. Does
  not invent a section 7.1 recipe. Does not steal G30
  useful-install selection from DR-117. Does not retarget G22 /
  DR-126. Does not occupy the G01-G05 identifiers. Does not
  SATISFY DR-101. Does not SATISFY DR-117. Does not SATISFY
  DR-126. Does not flatten DR-118 `DECIDED-V1-NOT-INTEGRATED` to
  `OPEN`. Does not flatten DR-107 `PROPOSED-CLOSED-FOR-REVIEW` to
  `OPEN`. Does not SATISFY DR-131. Does not SATISFY DR-133. Does
  not SATISFY DR-114. Gate 1 Class A is not opened. Not SATISFIED.
  Required-now stays 28. Condition-4 effect is zero. Naming parent
  of G01-G05 is naming v6 (D-145); the naming parent is not
  leftover-join.v9. D-086 named DR-G01, DR-G02, and DR-G05. D-102
  named DR-G03 and DR-G04. Claude Stage A leftover-join.v9
  returned 3 named observationsNotFindings objects OBS-1, OBS-2,
  OBS-3 (each with members id, observation); no change requested;
  they carry those identifiers. It returned no observations field
  and no advisories field. Codex Stage A leftover-join.v9 returned
  an empty observationsNotFindings list. It returned no
  observations field and zero advisories. This entry names those
  Claude identifiers. It does not invent a Codex identifier. It
  does not claim that both reviewers' identifiers are preserved.
  Codex Stage A returned no observation identifiers.
  leftover-join.v9 lands CLAUDE-DCLJ-V8-SF1 and
  CLAUDE-DCLJ-V8-SF2, the Claude Stage A findings on
  leftover-join.v8, and re-lands nothing. Its lands list grows
  from the two members leftover-join.v7 and leftover-join.v8 share
  (CLAUDE-DCLJ-V4-SF1, landed in this lineage at leftover-join.v5;
  CLAUDE-DCLJ-V6-SF1, at leftover-join.v7) to four, appending
  those two identifiers. Its findingDisposition carries
  leftover-join.v7's three identifiers in the same order
  (DCLJ-V1-B1 and DCLJ-V1-SF1, landed at leftover-join.v3;
  CLAUDE-DCLJ-V6-SF1, landed at leftover-join.v7), each reading
  `ACCEPTED` in leftover-join.v7 and, in leftover-join.v9,
  `ACCEPTED. Landed in this lineage at leftover-join.v3. This v9
  does not re-land it.` for the first two and `ACCEPTED. Landed in
  this lineage at leftover-join.v7. This v9 does not re-land it.`
  for the third, no other member of those three differing; it then
  appends entries for CLAUDE-DCLJ-V8-SF1 (landedAt
  obligations[OBL-2].reason) and CLAUDE-DCLJ-V8-SF2 (landedAt
  purpose). Its landsNote recites that cumulative landing record
  as carried from leftover-join.v7 and extended at
  leftover-join.v9. leftover-join.v9 adds no top-level field
  absent from leftover-join.v8; relative to leftover-join.v7 it
  adds registerRowNote, requiredNowUnchanged, file08StatusToken,
  landsNote, and parentReview. basedOn.d286.role is last-heading
  custody only. Claude Stage B returned 6 named
  observationsNotFindings objects D287-ADV-O1, D287-ADV-O2,
  D287-ADV-O3, D287-ADV-O4, D287-ADV-O5, D287-ADV-O6 (each with
  members id, observation, whyNotAFinding); no change requested;
  they carry those identifiers. It returned an empty observations
  list and zero advisories. Codex Stage B returned an empty
  observationsNotFindings list. It returned no observations field
  ...
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage B
  returned no observation identifiers. Does not execute G01-G05.
  Does not rewrite G01 occupancy v9, G02 occupancy v4, G03
  occupancy v5, G04 occupancy v4, or G05 occupancy v4. Does not
  edit file 08. Does not authorize `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D287. Does not unwrite D-086, D-102, D-114, D-145, D-158,
  D-159, D-160, D-173, D-231, D-232, D-233, D-234, D-235, or
  D-286.
- **Commit:** C-D287.

## D-288 — Record g09 leftover-join.v12 as G09 leftover remasurement

- **Date:** 2026-08-27
- **Status:** **ADOPTED 2026-08-27.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-288.review-adversarial.claude2.json`,
  `b69f70cf22a452192ac03b30b1f1d134e7767c14eb1abe81963a98759fb2dced`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-288.review-adversarial.codex.json`,
  `46edb878696b9b031e73b4c77a5f2f8976086c7220c04f986171e83349d159e9`)
  CONSENT. Subject `coordinator-decisions.D-288.draft.md`
  `9d2c89bf8f83fb472eec79ee30ef542f6c4d34d9c5d57c9260bb390ca4066de9`.
  Frozen leftover-join `g09-leftover-join.v12.json`
  `fc96ba91080ccef81259c6eb5ac004303a2b919e922d4bb54a448e26d149727c`
  Stage A Claude ACCEPT
  `49988f3ba7f809e8ce64a32a0d32047ad1b7ed5888128153cca46ccb021f4070`
  0/0; Stage A Codex ACCEPT
  `7f7ac8631195d3798259d4196b14682bde290a87027eade946e74ba6cc5e2c19`
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g09-leftover-join.v12.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  ...
  D-274 and D-275 and D-276 and D-277 and D-278 and D-279 and
  D-280 and D-281 and D-282 and D-283 and D-284 and D-285 and
  D-286 and D-287. D-272 is CONTESTED and is not on this
  no-cell-edit adoption branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g09-leftover-join.v12.json`
  `fc96ba91080ccef81259c6eb5ac004303a2b919e922d4bb54a448e26d149727c`.
- **Decision:** Record leftover-join.v12 as G09 leftover
  remasurement after D-287. The candidate binds NOTHING. DR-G09
  stays `OPEN`. leftover-design of OBL-FX-AUTHORING remains on
  leftover-join.v12. leftover-join.v11 remains current at draft
  time. After this successor is recorded, leftover-join.v11 is not
  current.  G09 occupancy v4 is the current G09 occupancy
  remasurement (D-220). G09 occupancy v3 is not recorded as
  current occupancy. permission leftover-join.v12 remains the
  current DR-105 ROW leftover-join (D-283). doctor-actor
  leftover-join.v12 remains the current DR-114 ROW leftover-join
  (D-285). permission leftover-join.v9 is not recorded as current
  DR-105 leftover-join. doctor-actor leftover-join.v11 is not
  recorded as current DR-114 leftover-join. Remainder of G09
  execution remains qualification (D-056). OBL-G09-NAMED-CATALOG,
  OBL-G09-INPUT-CORPUS, and OBL-R10-R6-INPUT-CORPUS remain
  measured closed; permission leftover-join.v12 (D-283) measures
  OBL-FX-INPUT-CORPUS and OBL-R10-R6-INPUT-CORPUS leftoverDesign
  false on DR-105 as permission leftover-join.v9 (D-171) did. Does
  not pin QUALIFIED. Does not invent fixture bytes. Does not
  invent a D9 code. Does not invent a section 7.1 recipe. Does not
  invent a decision-record envelope. Does not steal
  OBL-R10-AUTHORING, OBL-R6-AUTHORING, OBL-FC-C1, or OBL-BLK-1..4.
  Does not steal the DR-114 remainder. Does not occupy the
  identifier. Does not SATISFY DR-105. Does not SATISFY DR-117.
  Does not SATISFY DR-131. Does not SATISFY DR-133. Does not
  SATISFY DR-114. Does not SATISFY DR-101. Gate 1 Class A is not
  opened. Not SATISFIED. Required-now stays 28. Condition-4 effect
  is zero. Naming parent of G09 is naming v6 (D-145), not
  leftover-join.v12. D-086 named DR-G09. Claude Stage A
  leftover-join.v12 returned 4 named observationsNotFindings
  objects CLAUDE-G09LJ-V12-OBS1, CLAUDE-G09LJ-V12-OBS2,
  CLAUDE-G09LJ-V12-OBS3, CLAUDE-G09LJ-V12-OBS4 (each with members
  id, observation, whyNotAFinding); no change requested; they
  carry those identifiers. It returned no observations field and
  no advisories field. Codex Stage A leftover-join.v12 returned an
  empty observationsNotFindings list. It returned no observations
  field and zero advisories. This entry names those Claude
  identifiers. It does not invent a Codex identifier. It does not
  claim that both reviewers' identifiers are preserved. Codex
  Stage A returned no observation identifiers. leftover-join.v12
  lands no new finding and re-lands nothing. Neither
  leftover-join.v11 nor leftover-join.v12 has a lands field. Its
  findingDisposition carries the same nine identifiers as
  leftover-join.v11's, in the same order (G09LJ-V4-B1,
  G09LJ-V4-B2, G09-V4-SF1, G09LJ-V5-B1, G09LJ-V5-SF1,
  G09LJ-V6-SF1, G09LJ-V7-SF1, G09LJ-V8-SF1, G09LJ-V9-SF1), with
  the same severity and landedAt members; each disposition reads
  `ACCEPTED` in leftover-join.v11 and, in leftover-join.v12,
  `ACCEPTED. Landed in this lineage at leftover-join.v5. This v12
  does not re-land it.` for G09LJ-V4-B1 and G09-V4-SF1; `ACCEPTED.
  Landed in this lineage at leftover-join.v5
  (basedOn.permissionJoinV7.review.codex) and leftover-join.v6
  (basedOn.permissionJoinV7.review.verdict, repaired under
  G09LJ-V5-B1). This v12 does not re-land it.` for G09LJ-V4-B2;
  `ACCEPTED. Landed in this lineage at leftover-join.v6. This v12
  does not re-land it.` for G09LJ-V5-B1 and G09LJ-V5-SF1;
  `ACCEPTED. Landed in this lineage at leftover-join.v7. This v12
  does not re-land it.` for G09LJ-V6-SF1; `ACCEPTED. Landed in
  this lineage at leftover-join.v8. This v12 does not re-land it.`
  for G09LJ-V7-SF1; `ACCEPTED. Landed in this lineage at
  leftover-join.v9. This v12 does not re-land it.` for
  G09LJ-V8-SF1; `ACCEPTED. Landed in this lineage at
  leftover-join.v10. This v12 does not re-land it.` for
  G09LJ-V9-SF1. No other findingDisposition member differs.
  basedOn.d287.role is last-heading custody only. Claude Stage B
  returned 8 named observationsNotFindings objects D288-ADV-O1,
  D288-ADV-O2, D288-ADV-O3, D288-ADV-O4, D288-ADV-O5, D288-ADV-O6,
  D288-ADV-O7, D288-ADV-O8 (each with members id, observation,
  whyNotAFinding); no change requested; they carry those
  identifiers. It returned an empty observations list and zero
  advisories. Codex Stage B returned an empty
  observationsNotFindings list. It returned no observations field
  ...
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage B
  returned no observation identifiers. Does not execute G09. Does
  not rewrite occupancy v4. Does not edit file 08. Does not
  authorize `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D288. Does not unwrite D-086, D-189, D-220, D-257, D-283,
  D-285, or D-287.
- **Commit:** C-D288.

## D-289 — Record g12 leftover-join.v5 as G12 leftover remasurement

- **Date:** 2026-08-27
- **Status:** **ADOPTED 2026-08-27.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-289.review-adversarial.claude2.json`,
  `efdbdab3984d61ef27c90d487822113316e487d5e0b6a442a62dc29806a78db1`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-289.review-adversarial.codex.json`,
  `b70a2b74bafbdd7df52bcefa5137ae317c66de09e5a0f2091218935cdd4f6e8b`)
  CONSENT. Subject `coordinator-decisions.D-289.draft.md`
  `0c325f8f502501fb3a19f1c10f0ef2b28676e9544febfc49d6e548957f750a7f`.
  Frozen leftover-join `g12-leftover-join.v5.json`
  `5770cc9cb993ba5ac467df4648820167addff7b5f7a10d4442fa7e57913779d4`
  Stage A Claude ACCEPT
  `0c25c09163cbd965304613adebd87a787347a694c0bd8bfbcfbfd9d2089588d2`
  0/0; Stage A Codex ACCEPT
  `ea17e8f9ec6be52694f1f275f7ed92896a8416eb715b144574eaec8c4dd41b3e`
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g12-leftover-join.v5.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  ...
  D-274 and D-275 and D-276 and D-277 and D-278 and D-279 and
  D-280 and D-281 and D-282 and D-283 and D-284 and D-285 and
  D-286 and D-287 and D-288. D-272 is CONTESTED and is not on this
  no-cell-edit adoption branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g12-leftover-join.v5.json`
  `5770cc9cb993ba5ac467df4648820167addff7b5f7a10d4442fa7e57913779d4`.
- **Decision:** Record leftover-join.v5 as G12 leftover
  remasurement after D-288. The candidate binds NOTHING. DR-G12
  stays `OPEN`. leftover-design of OBL-DOCTOR-FX-AUTHORING remains
  on leftover-join.v5. leftover-join.v4 remains current at draft
  time. After this successor is recorded, leftover-join.v4 is not
  current.  G12 occupancy v6 is the current G12 occupancy
  remasurement (D-221).  doctor-actor leftover-join.v12 remains
  the current DR-114 ROW leftover-join (D-285). doctor-actor
  leftover-join.v11 is not recorded as current DR-114
  leftover-join. Remainder of G12 execution remains qualification
  (D-056). OBL-G12-HARNESS-SPEC, OBL-G12-NAMED-CATALOG, and
  OBL-G12-INPUT-CORPUS remain measured closed;
  OBL-DR114-LEFTOVER-NOT-STOLEN rides DR-114 on doctor-actor
  leftover-join.v12 (D-285). Occupancy v6 (D-221) remains the
  current G12 occupancy remasurement; this act changes no
  occupancy claim. Does not pin QUALIFIED. Does not invent fixture
  bytes. Does not invent a D9 code. Does not invent a section 7.1
  recipe. Does not take over G21. Does not steal DR-114 leftover.
  Does not occupy the identifier. Does not SATISFY DR-114. Gate 1
  Class A is not opened. Not SATISFIED. Required-now stays 28.
  Condition-4 effect is zero. Naming parent of G12 is naming v6
  (D-145), not leftover-join.v5. D-086 named DR-G12. Claude Stage
  A leftover-join.v5 returned 6 unlabeled observationsNotFindings
  objects (each with members observation, whyNotAFinding; no
  identifiers). It returned no observations field and no
  advisories field. Codex Stage A leftover-join.v5 returned an
  empty observationsNotFindings list. It returned no observations
  field and zero advisories. This entry does not invent
  identifiers. It does not claim that both reviewers' identifiers
  are preserved. Claude Stage A returned no observation
  identifiers. Codex Stage A returned no observation identifiers.
  leftover-join.v5 lands no new finding and re-lands nothing.
  Neither leftover-join.v4 nor leftover-join.v5 has a lands field,
  and neither has a findingDisposition field. leftover-join.v5
  adds no top-level field to leftover-join.v4; its top-level key
  order is identical. Within basedOn it drops the d257
  last-heading custody entry and adds d288, d258, d285,
  doctorJoinV12, and predecessorV4. basedOn.d288.role is
  last-heading custody only. Claude Stage B returned 8 named
  observationsNotFindings objects D289-ADV-O1, D289-ADV-O2,
  D289-ADV-O3, D289-ADV-O4, D289-ADV-O5, D289-ADV-O6, D289-ADV-O7,
  D289-ADV-O8 (each with members id, observation, whyNotAFinding);
  no change requested; they carry those identifiers. It returned
  an empty observations list and zero advisories. Codex Stage B
  returned an empty observationsNotFindings list. It returned no
  observations field and zero advisories. This entry names those
  ...
  does not claim that both reviewers' identifiers are preserved.
  Codex Stage B returned no observation identifiers. Does not
  execute G12. Does not rewrite occupancy v6. Does not edit file
  08. Does not authorize `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
...
- **Status:** **ADOPTED 2026-08-27.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-291.review-adversarial.claude2.json`,
  `153f3a57909a0922970e68f824d5548816d41e6a57281a704ef246354f3b2602`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-291.review-adversarial.codex.json`,
  `fa1b53242912bb661fde220f0f1a46d7f478e7b0ee85032c7b4ef39e86947c83`)
  CONSENT. Subject `coordinator-decisions.D-291.draft.md`
  `2930f07b4b3d8fd68e4dfa54f96e0088dc66a15bc53069bae4f89198be2e5f05`.
  Frozen leftover-join `g19-leftover-join.v5.json`
  ...
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g19-leftover-join.v5.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  ...
  D-274 and D-275 and D-276 and D-277 and D-278 and D-279 and
  D-280 and D-281 and D-282 and D-283 and D-284 and D-285 and
  D-286 and D-287 and D-288 and D-289 and D-290. D-272 is
  CONTESTED and is not on this no-cell-edit adoption branch. Not a
  three-limb act. Not SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g19-leftover-join.v5.json`
  `d7bce01edb64e25ac70df8feb9119e2e87aadd40c6259ffd50d797e9bfb6d126`.
- **Decision:** Record leftover-join.v5 as G19 leftover
  remasurement after D-290. The candidate binds NOTHING. DR-G19
  stays `OPEN`. leftover-design of OBL-G19-FX-AUTHORING remains on
  leftover-join.v5. leftover-join.v4 remains current at draft
  time. After this successor is recorded, leftover-join.v4 is not
  current.  G19 occupancy v2 is the current G19 occupancy
  remasurement (D-222). G19 occupancy v1 is not recorded as
  current occupancy. state-class leftover-join.v4 remains the
  current DR-124 ROW leftover-join (D-284). state-class
  leftover-join.v3 is not recorded as current DR-124
  leftover-join. Remainder of G19 execution remains qualification
  (D-056). OBL-G19-HARNESS-SPEC, OBL-G19-NAMED-CATALOG, and
  OBL-G19-INPUT-CORPUS remain measured closed. Occupancy v2
  (D-222) remains the current G19 occupancy remasurement; g19
  leftover-join.v5 cites the same occupancy as g19
  leftover-join.v4 did. Does not pin QUALIFIED. Does not invent
  fixture bytes. Does not invent a grant-journal, inherit-blocked
  envelope, monotonic window, or sealed-Run class. Does not invent
  a D9 code. Does not invent a section 7.1 recipe. Does not take
  over G27. Does not steal DR-124 leftover. Does not occupy the
  identifier. Does not SATISFY DR-124. Gate 1 Class A is not
  opened. Not SATISFIED. Required-now stays 28. Condition-4 effect
  is zero. Naming parent of G19 is naming v6 (D-145), not
  leftover-join.v5. D-086 named DR-G19. Claude Stage A
  leftover-join.v5 returned 4 named observationsNotFindings
  objects O1, O2, O3, O4 (each with members id, observation,
  whyNotAFinding); no change requested; they carry those
  identifiers. It returned no observations field and no advisories
  field. Codex Stage A leftover-join.v5 returned an empty
  observationsNotFindings list. It returned no observations field
  and zero advisories. This entry names those Claude identifiers.
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage A
  returned no observation identifiers. g19 leftover-join.v5 lands
  no new finding and re-lands nothing. Neither g19
  leftover-join.v4 nor g19 leftover-join.v5 has a lands field or a
  findingDisposition field. g19 leftover-join.v5 adds "It lands no
  new finding." to authorityClaim and "Does not land or re-land
  any finding." to doesNot; no finding identifier appears in
  either file. basedOn.d290.role is last-heading custody only.
  Claude Stage B returned 8 named observationsNotFindings objects
  D291-ADV-O1, D291-ADV-O2, D291-ADV-O3, D291-ADV-O4, D291-ADV-O5,
  D291-ADV-O6, D291-ADV-O7, D291-ADV-O8 (each with members id,
  observation, whyNotAFinding); no change requested; they carry
  those identifiers. It returned an empty observations list and
  zero advisories. Codex Stage B returned an empty
  observationsNotFindings list. It returned no observations field
  and zero advisories. This entry names those Claude identifiers.
  It does not invent a Codex identifier. It does not claim that
...
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D291. Does not unwrite D-086, D-194, D-222, D-256, D-284, or
  D-290.
- **Commit:** C-D291.
...
- **Date:** 2026-08-27
- **Status:** **ADOPTED 2026-08-27.** Turn 2 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-292.review-adversarial.claude2.turn2.json`,
  `6d68a844605ad246ed73e6cb0ca2e9fafb6cea9b08e138da634951cb845d4bb1`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-292.review-adversarial.codex.turn2.json`,
  `dad8864ecc8d83d7a00186e610866e2a76481ab55fc37adf12d5fb5a3a0cfba8`)
  CONSENT. Subject `coordinator-decisions.D-292.turn2.draft.md`
  `c285628163c3436ab4dd2dcf70f67cfeafe68c86fb57a45e940974f982913657`.
  turn-1 Claude OBJECT (CLAUDE-D292-SF1 / CLAUDE-D292-SF2)
  `e42af1047a65aafc1135e5fddfc2164e85ff01a58bb9d13909dbc033f54ab68b`;
  turn-1 Codex CONSENT
  `b217d45377c35fb89b5ee6515f631eb9b1b9e3a1e10a33ded5948a4701705b46`.
  Frozen leftover-join `g21-leftover-join.v13.json`
  ...
  0/0.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g21-leftover-join.v13.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 and D-238 and D-239 and D-240 and D-241 and D-242 and
  D-243 and D-244 and D-245 and D-246 and D-247 and D-248 and
  D-249 and D-250 and D-251 and D-252 and D-253 and D-254 and
  ...
  D-274 and D-275 and D-276 and D-277 and D-278 and D-279 and
  D-280 and D-281 and D-282 and D-283 and D-284 and D-285 and
  D-286 and D-287 and D-288 and D-289 and D-290 and D-291. D-272
  is CONTESTED and is not on this no-cell-edit adoption branch.
  Not a three-limb act. Not SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g21-leftover-join.v13.json`
  `058717f51ee62e85fa3094e9a65c207fb78a7f706e57a35a854f1a9a55ecc66e`.
- **Decision:** Record leftover-join.v13 as G21 leftover
  remasurement after D-291. Lands CLAUDE-D292-SF1,
  CLAUDE-D292-SF2. All identifiers are named. The candidate binds
  NOTHING. DR-G21 stays `OPEN`. leftover-design of
  OBL-G21-FX-AUTHORING remains on leftover-join.v13.
  leftover-join.v12 remains current at draft time. After this
  successor is recorded, leftover-join.v12 is not current.  G21
  occupancy v4 is the current G21 occupancy remasurement (D-218).
  doctor-actor leftover-join.v12 remains the current DR-114 ROW
  leftover-join (D-285). doctor-actor leftover-join.v11 is not
  recorded as current DR-114 leftover-join. leftover-design of
  NT-1 and NT-2 implementations, of per-D-002-platform copies of
  those implementations, of the two CC-5 prefix injections, and of
  per-D-002-platform copies of those two CC-5 payloads remains
  stale as an authoring claim, as leftover-join.v12 measured.
  Remaining CC-5 injections stay unauthored. Remaining G21 classes
  stay unauthored. Remainder of G21 execution, including
  candidate-buffer digest, subsequent-session view,
  host-projection goldens, and EV-5 diagnostic/audit bytes,
  remains qualification (D-056). OBL-G21-NAMED-CATALOG and
  OBL-G21-INPUT-CORPUS remain measured closed;
  OBL-G21-HARNESS-SPEC authoring remains measured closed against
  occupancy v4. Does not pin QUALIFIED. Does not invent fixture
  bytes. Does not invent a D-002 platform list. Does not claim
  CC-5 fully authored. Does not classify non-object top level as
  CC-5. Does not author NT-6. Does not invent a CC, NT, or FC
  identifier. Does not invent a D9 code, exit number, or
  HostTermination. Does not invent a section 7.1 recipe. Does not
  steal DR-114 leftover. Does not occupy the identifier. Does not
  reopen DR-102 SATISFIED. Does not SATISFY DR-114. Does not
  SATISFY DR-133. Does not SATISFY DR-117. Does not SATISFY
  DR-131. Does not SATISFY DR-101. Gate 1 Class A is not opened.
  Not SATISFIED. Required-now stays 28. Condition-4 effect is
  zero. Naming parent of G21 is naming v6 (D-145), not
  leftover-join.v13. D-086 named DR-G21. Claude Stage A
  leftover-join.v13 returned no observationsNotFindings field. It
  returned 1 named observations object OBS-1 (with members id,
  severity, location, note); no change requested; it carries that
  identifier. It returned no advisories field. Codex Stage A
  leftover-join.v13 returned 1 unlabeled observationsNotFindings
  object (with members observation, whyNotAFinding; no
  identifiers). It returned no observations field and zero
  advisories. This entry names that Claude identifier. It does not
  invent a Codex identifier. It does not claim that both
  reviewers' identifiers are preserved. Codex Stage A returned no
  observation identifiers. leftover-join.v13 lands no new finding
  and re-lands nothing. Neither leftover-join.v12 nor
  leftover-join.v13 has a lands field. findingDisposition carries
  the single identifier G21LJ-V3-SF1 in both: leftover-join.v12
  reads disposition `ACCEPTED` and landed `Landed in this lineage
  at v4. Unmoved. Not this artifact's version number.`;
  leftover-join.v13 reads disposition `ACCEPTED. Landed in this
  lineage at leftover-join.v4. This v13 does not re-land it.` and
  landed `Landed in this lineage at leftover-join.v4. Unmoved. Not
  this artifact's version number.`. appliesFindingsOf carries
  G21LJ-V5-M1, G21LJ-V5-SF1, G21LJ-V6-SF1, G21LJ-V8-SF1, and
  G21LJ-V10-SF1 as ACCEPTED in both; leftover-join.v13 relabels
  leftover-join.v12's speaker sentences there as history and
  qualifies every version token; no disposition changes.
  basedOn.d291.role is last-heading custody only. Claude Stage B
  returned 6 named observationsNotFindings objects D292-T2-ADV-O1,
  D292-T2-ADV-O2, D292-T2-ADV-O3, D292-T2-ADV-O4, D292-T2-ADV-O5,
  D292-T2-ADV-O6 (each with members id, observation,
  whyNotAFinding); no change requested; they carry those
  identifiers. It returned no observations field and zero
  advisories. Codex Stage B returned an empty
  observationsNotFindings list. It returned no observations field
  ...
  both reviewers' identifiers are preserved. Codex Stage B
  returned no observation identifiers. Claude Stage B turn 1
  returned 5 named observationsNotFindings objects D292-ADV-O1,
  D292-ADV-O2, D292-ADV-O3, D292-ADV-O4, D292-ADV-O5 (each with
  members id, observation, whyNotAFinding); no change requested;
  they carry those identifiers. It returned no observations field
  and zero advisories. Codex Stage B turn 1 returned an empty
  observationsNotFindings list. It returned no observations field
  ...
  It does not invent a Codex identifier. It does not claim that
  both reviewers' identifiers are preserved. Codex Stage B turn 1
  returned no observation identifiers. Does not execute G21. Does
  not rewrite occupancy v4. Does not edit file 08. Does not
  authorize `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
...
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D292. Does not unwrite D-086, D-145, D-170, D-196, D-218,
...
- **Status:** **ADOPTED 2026-08-28.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-298.review-adversarial.claude2.json`,
  `492b8021223e0c495081fa559644f9bdc9ede479575d6ff2756bb26dfc539e2c`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-298.review-adversarial.codex.json`,
  `187931084cbb1f6030d265232dadb3d9ecaeda0cf85596fb874ea67ed93e09ce`)
  CONSENT. Subject `coordinator-decisions.D-298.draft.md`
  `d188552205e7fbae15208b3397162cfb5735b12fcd1414fcd92330e2a7589203`.
  Frozen successor `g20-fixture-corpus.v5.json`
  `3d7d8dba4a7409b98720ae04a8f826f84271e9acfd7c804f2a21e12b78d612c8`
  Stage A Claude ACCEPT
  `2854f32bb642e8d6d7e08ebf0e0f5ba538015c19c74c866378f8bf634ddd4e33`
  0/0; Stage A Codex ACCEPT
  `1a5361715ad36a1724f0525806f595a66a8e742cf4ebe25d2be42c019b3f88b5`
  0/0. Claude 2 Stage B turn-1 returned 3 named advisories objects
  CLAUDE-D298-A1, CLAUDE-D298-A2, CLAUDE-D298-A3 (with members
  blocking, field, id, ifEverRepaired, measurement, severity,
  title, whyNotShouldFix); they travel as honesty work. Codex
  Stage B turn-1 returned an empty mustFix list; an empty
  shouldFix list; an empty advisories list; no
  observationsNotFindings field.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g20-fixture-corpus.v5.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 through D-271 and D-273 through D-297. D-272 is CONTESTED
  and is not on that branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g20-fixture-corpus.v5.json`
  `3d7d8dba4a7409b98720ae04a8f826f84271e9acfd7c804f2a21e12b78d612c8`.
- **Decision:** Record g20-fixture-corpus.v5 as DR-G20
  leftover-design fixture implementations after D-297. The
  candidate binds NOTHING. DR-G20 stays `OPEN`. leftover-design of
  OBL-G20-FX-AUTHORING remains on leftover-join.v6 (D-269) and on
  sdk leftover-join.v6 (D-267) because leftover-join remasurement
  is not this entry, and closing that obligation needs a successor
  on both joins. leftover-design of OBL-SDK-API-RESERVED remains
  on sdk leftover-join.v6. Does not remasure leftover-join.v6.
  Does not remasure sdk leftover-join.v6. Does not SATISFY DR-125.
  Does not SATISFY DR-133. D-056 Eligibility gates 2 and 3 do not
  hold for DR-G20. Gate 1 Class A is not opened. Not eligible in
  kind. Not SATISFIED. Required-now stays 28. Condition-4 effect
  is zero. Frozen g20-fixture-corpus.v1, g20-fixture-corpus.v2,
  g20-fixture-corpus.v3, and g20-fixture-corpus.v4 stay frozen; do
  not record them as current. Claude Stage A advisories
  CLAUDE-G20FX-V5-A-1, CLAUDE-G20FX-V5-A-2, CLAUDE-G20FX-V5-A-3,
  CLAUDE-G20FX-V5-A-4 travel as honesty work. Does not invent an
  SDK API, a D9 code, a RunId recipe, a CommandEnvelope schema, or
  a D-002 platform list. Does not advertise SARIF. Does not
  resurrect G17. Does not edit file 08. Does not authorize
  `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
...
## D-302 — Record g21-fixture-corpus.v14 as G21 leftover-design per-D-002-platform copies of the CC-5 far-over prefix injection

- **Date:** 2026-08-29
- **Status:** **ADOPTED 2026-08-29.** Turn 2 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-302.review-adversarial.claude2.turn2.json`,
  `a5d944e07c770fa8ae1fe28d44ab1234aa0c6464ecd1eb3780683d03b99cb1a9`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-302.review-adversarial.codex.turn2.json`,
  `1f0200990b89f815128fd43e6fb20f31067145d0e6838f264782807ec2b6149b`)
  CONSENT. Subject `coordinator-decisions.D-302.turn2.draft.md`
  `a7b1f64490b7f058ee16111ecf49acd755ab1736af24a4fc958b350eeb033546`.
  Frozen successor `g21-fixture-corpus.v14.json`
  `1012bb023df44e455909eb981592231b4ae8958712d5fad55f2324c920d864ae`
  Stage A Claude ACCEPT
  `a9148a187e605e2fa550659596451b489f423c94987e9183b372d91ffd1e275e`
  0/0; Stage A Codex ACCEPT
  `5e9431954d1b15a8fa4d5d9119d8dfb1142af000b4397dc434daf5b99217c1e5`
  0/0. Prior turns: turn-1 Claude 2 OBJECT 0 MUST-FIX, 1
  SHOULD-FIX CLAUDE-D302-S-1
  (`artifacts/coordinator-decisions.D-302.review-adversarial.claude2.json`,
  `d61b55dde51eb3cfef424b8eab8606d376c08ba3f4f41447019a6d49a9139f2a`);
  turn-1 Codex CONSENT 0/0
  (`artifacts/coordinator-decisions.D-302.review-adversarial.codex.json`,
  `da3430b60234b65fb319749747f10f8cf15d7b4db3fb8e1e6065a7d628288936`).
  Claude 2 Stage B turn-2 returned 3 named advisories objects
  CLAUDE-D302-T2-A-1, CLAUDE-D302-T2-A-2, CLAUDE-D302-T2-A-3 (with
  members id, measurement, severity, status, title,
  whyNotAFinding) and 3 named observations objects
  CLAUDE-D302-T2-O-1, CLAUDE-D302-T2-O-2, CLAUDE-D302-T2-O-3 (with
  members id, measurement, title); they travel as honesty work.
  ...
  list; no observationsNotFindings field.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `g21-fixture-corpus.v14.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 through D-271 and D-273 through D-301. D-272 is CONTESTED
  and is not on that branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:** `docs/coop/artifacts/g21-fixture-corpus.v14.json`
  `1012bb023df44e455909eb981592231b4ae8958712d5fad55f2324c920d864ae`.
- **Decision:** Record g21-fixture-corpus.v14 as G21
  leftover-design per-D-002-platform copies of the CC-5 far-over
  prefix injection after D-301. The candidate binds NOTHING.
  DR-G21 stays `OPEN`. leftover-design of OBL-G21-FX-AUTHORING
  remains on g21 leftover-join.v13 (D-292) because leftover-join
  remasurement is not this entry, because CC-5 is not fully
  authored, and because closing that obligation needs a successor
  on g21 leftover-join alone (no same-id ROW twin). Does not
  remasure g21 leftover-join.v13. Does not steal leftover-design
  of OBL-HOSTILE-GOLDENS remaining on
  anti-lockstep-leftover-join.v3. Does not SATISFY DR-114. Does
  not SATISFY DR-133. Does not author NT-6. Does not author
  FC-NC-CA1-PROCESS-TREE. Does not pin N=65536 as prefix-only
  RF-2. Does not author prefix exactly at the operative bound.
  Does not author the postHandshake far-over half. D-056
  Eligibility gates 2 and 3 do not hold for DR-G21. Gate 1 Class A
  is not opened. Not eligible in kind. Not SATISFIED. Required-now
  stays 28. Condition-4 effect is zero. Frozen
  g21-fixture-corpus.v12 and g21-fixture-corpus.v13 stay frozen;
  do not record them as current. Claude Stage A advisories
  CLAUDE-G21FXV14-A-1, CLAUDE-G21FXV14-A-2, CLAUDE-G21FXV14-A-3,
  CLAUDE-G21FXV14-A-4 and observations CLAUDE-G21FXV14-O-1,
  CLAUDE-G21FXV14-O-2, CLAUDE-G21FXV14-O-3, CLAUDE-G21FXV14-O-4,
  CLAUDE-G21FXV14-O-5 travel as honesty work. Claude Stage B
  turn-1 SHOULD-FIX CLAUDE-D302-S-1 is landed. Claude Stage B
  turn-1 advisories CLAUDE-D302-A-1, CLAUDE-D302-A-2,
  CLAUDE-D302-A-3 and observations CLAUDE-D302-O-1,
  CLAUDE-D302-O-2, CLAUDE-D302-O-3 travel as honesty work. Codex
  Stage B turn-1 returned no observation identifiers. Does not
  invent a D9 code, a ping body schema, a RunId recipe, or a D-002
  platform list. Does not edit file 08. Does not authorize
  `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D302. Does not unwrite D-015, D-056, D-086, D-218, D-241,
...
- **Status:** **ADOPTED 2026-08-29.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-305.review-adversarial.claude2.json`,
  `4c344fa45de73915114bb759c960bc7ed26039bc3808234cb264b4ec92878ad2`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-305.review-adversarial.codex.json`,
  `c4d79cc346db535834f8592cc2c0166f2244d287fd4aa2f03f1f1dba70d42206`)
  CONSENT. Subject `coordinator-decisions.D-305.draft.md`
  `762622cf5a22a010d7ddcf7b3825d8bbff6420cd903e396e53f632dbc79be221`.
  Frozen occupancy `harness.DR-G01.core-download.v11.json`
  `f95f0178430c04b655121dcc9b68031f160e6ccf493057a8e288eec79306aa94`
  Stage A Claude ACCEPT
  `abed5382612a3c8124686efe7f704803a64314398ca2dc93fbb687ec605d59a2`
  0/0; Stage A Codex ACCEPT
  `5901b4c4225e759efcb9496614d238f95b6425c459f0bf1e22a71deaf866da0f`
  0/0. Claude 2 Stage B turn-1 returned 4 named observations
  objects CLAUDE-D305-O1, CLAUDE-D305-O2, CLAUDE-D305-O3,
  CLAUDE-D305-O4 (members id, observation, severity, where,
  ...
  observationsNotFindings list.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `harness.DR-G01.core-download.v11.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 through D-271 and D-273 through D-304. D-272 is CONTESTED
  and is not on that branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:**
  `docs/coop/artifacts/harness.DR-G01.core-download.v11.json`
  `f95f0178430c04b655121dcc9b68031f160e6ccf493057a8e288eec79306aa94`.
- **Decision:** Record harness.DR-G01.core-download.v11 as G01
  occupancy remasurement after D-304. The candidate binds NOTHING.
  DR-G01 stays `OPEN`. leftover-design of the G01
  ...
  qualification (D-056). D-293 decided the unit; G01 occupancy v11
  cites that unit so G01 size comparison is specified scorable
  under MB = 1e6 bytes; G02 tree-accounting remains UNDECIDED.
  Does not write a derived byte constant. Does not pin QUALIFIED.
  Does not invent fixture bytes. Does not mint Rust-as-core. Does
  not take over G02, G03, G04, G05, G07, G14, or G22. Does not
  SATISFY DR-101. Does not SATISFY DR-117. Does not SATISFY
  DR-131. Does not SATISFY DR-133. Gate 1 Class A is not opened.
  Class B SATISFIED is not recorded. Not SATISFIED. Required-now
  stays 28. Condition-4 effect is zero. Naming parent is naming v6
  (D-145) dual ACCEPT 0/0. leftover-join.v9 is not parentReview.
  Frozen G01 occupancy v1 remains the CGHS promised-path
  occupancy. Frozen G01 occupancy v9 remains a historical
  occupancy remasurement recorded at D-231; after this successor
  is recorded, G01 occupancy v9 is not current. Frozen G01
  occupancy v10 stays frozen and unrecorded; do not record it as
  current. The unlabeled Codex Stage A G01 occupancy v10 MUST-FIX
  is landed. Claude Stage A observations CLAUDE-G01H-V11-OBS1,
  CLAUDE-G01H-V11-OBS2, CLAUDE-G01H-V11-OBS3 travel as honesty
  work. Advisory CLAUDE-G01H-V9-ADV1 travels as honesty work.
  Codex Stage A G01 occupancy v11 returned no observation
  identifiers. Does not invent an identifier for the unlabeled
  Codex G01 occupancy v10 MUST-FIX. Does not execute fixtures.
  Does not rewrite G02, G03, G04, G05, G07, G08, G09, G10, G12,
  G14, G15, G16, G18, G19, G20, G21, G22, G23, G24, G25, G26, G27,
  G28, G29, G30, G31, or G32. Does not rewrite frozen G01
  occupancy v1 through v10. Does not edit file 08. Does not invent
  a D9 code. Does not authorize `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
  last.
...
## D-307 — Record harness.DR-G04.core-memory.v5 as G04 occupancy remasurement

- **Date:** 2026-08-29
- **Status:** **ADOPTED 2026-08-29.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-307.review-adversarial.claude2.json`,
  `2f9b119e8c98150e68e4d0f873439d8b241f8f4221b7c721068421cabe686dba`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-307.review-adversarial.codex.json`,
  `98882b91e1c6909eea672c145939fb84c86af19b4a83a0dc3a8212a7200656ac`)
  CONSENT. Subject `coordinator-decisions.D-307.draft.md`
  `187f8da806a2c40894d6827c8e371ac729731f302dbd1ef99ed9d93a5da0a4c2`.
  Frozen occupancy `harness.DR-G04.core-memory.v5.json`
  `5a646c981cb26e18c32df32f4a6f625242d4be57d9167510c564b2f6591896de`
  Stage A Claude ACCEPT
  `53541939b6e81fba8d684d95fac28501b01d6cb2de1168b692e4f5c86149e312`
  0/0; Stage A Codex ACCEPT
  `e61198577c83f208bdd9cea78ac24980180058302a2f66231337df6b8c736d81`
  0/0. Claude 2 Stage B turn-1 returned 4 named observations
  objects CLAUDE-D307-O1, CLAUDE-D307-O2, CLAUDE-D307-O3,
  CLAUDE-D307-O4 (members id, observation, severity, where,
  whyItDoesNotStand); an empty mustFix list; an empty shouldFix
  list; an empty advisories list; no observationsNotFindings
  field; they travel as honesty work. Codex Stage B turn-1
  returned an empty mustFix list; an empty shouldFix list; an
  ...
  observationsNotFindings list.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `harness.DR-G04.core-memory.v5.json` (0 blockers, 0
  SHOULD-FIX). Same no-cell-edit branch as D-170 through D-235 and
  D-237 through D-271 and D-273 through D-306. D-272 is CONTESTED
  and is not on that branch. Not a three-limb act. Not
  SATISFIED-GRADE.
- **Subject:**
  `docs/coop/artifacts/harness.DR-G04.core-memory.v5.json`
  `5a646c981cb26e18c32df32f4a6f625242d4be57d9167510c564b2f6591896de`.
- **Decision:** Record harness.DR-G04.core-memory.v5 as G04
  occupancy remasurement after D-306. The candidate binds NOTHING.
  DR-G04 stays `OPEN`. leftover-design of the G04
  specification-authoring limb of OBL-2 remains measured stale.
  leftover-design of OBL-2, OBL-D1, and OBL-D2 remains. Remainder
  of OBL-2 on distribution-core leftover-join.v9 is (a) D-006 unit
  and G02 tree-accounting UNDECIDED, so size comparison cannot be
  scored on that join, and (b) G01-G05 execution, which remains
  qualification (D-056). D-293 decided the unit; G04 occupancy v5
  cites that unit so G04 bound comparison is specified scorable
  under MB = 1e6 bytes. Does not write a derived byte constant.
  Does not authorize a binary-MB byte constant. Does not invent
  G02 tree-accounting. Does not amend D-102. Does not pin
  QUALIFIED. Does not invent fixture bytes. Does not mint
  Rust-as-core. Does not take over G01, G02, G03, G05, G07, G14,
  or G22. Does not occupy the G02 identifier. Does not occupy the
  G03 identifier. Does not SATISFY DR-101. Does not SATISFY
  DR-117. Does not SATISFY DR-131. Does not SATISFY DR-133. Gate 1
  Class A is not opened. Class B SATISFIED is not recorded. Not
  SATISFIED. Required-now stays 28. Condition-4 effect is zero.
  Naming parent is naming v6 (D-145) dual ACCEPT 0/0.
  leftover-join.v9 is not parentReview. Frozen G04 occupancy v1
  remains the CGHS promised-path occupancy. Frozen G04 occupancy
  v4 remains a historical occupancy remasurement recorded at
  D-234; after this successor is recorded, G04 occupancy v4 is not
  current. CLAUDE-G04H-V3-B1 remains landed. Claude Stage A
  observationsNotFindings strings travel as honesty work; this
  entry does not invent identifiers for them. Codex Stage A G04
  occupancy v5 returned no observation identifiers. Does not
  execute fixtures. Does not rewrite G01, G02, G03, G05, G07, G08,
  G09, G10, G12, G14, G15, G16, G18, G19, G20, G21, G22, G23, G24,
  G25, G26, G27, G28, G29, G30, G31, or G32. Does not rewrite
  frozen G04 occupancy v1 through v4. Does not edit file 08. Does
  not invent a D9 code. Does not authorize
  `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
...
- **Reversibility:** Total only before a later dependent leftover
  rewrite, SATISFIED cycle, or file-08 cell rewrite. Overturn:
  C-D307. Does not unwrite D-102, D-145, D-173, D-234, D-287,
  D-293, D-294, D-306.
- **Commit:** C-D307.

---

## D-308 — Record distribution-core leftover-join.v10 as DR-101 leftover remasurement

- **Date:** 2026-08-29
- **Status:** **ADOPTED 2026-08-29.** Turn 1 of 3: CONSENT from
  both independent reviewers, 0 MUST-FIX, 0 SHOULD-FIX. Claude 2
  (`artifacts/coordinator-decisions.D-308.review-adversarial.claude2.json`,
  `0d2080c60f142d95efb1f4da22112182608445a0db4b17e065eb09f1edc31980`)
  CONSENT. Codex
  (`artifacts/coordinator-decisions.D-308.review-adversarial.codex.json`,
  `8c8d8698d9b7ffa6d304ce9b62dc0bc9321b31e684afdbbe6c6d9fb6f9b990ac`)
  CONSENT. Subject `coordinator-decisions.D-308.draft.md`
  `4ff5a4d001c0fb2fb28c9d71b427eeb6c4b33e1b865bb4946507d6178d8ffcbd`.
  Frozen successor `distribution-core-leftover-join.v10.json`
  `1de52b7675925e3ddb1b863113f019d5aec9a1eea760a85e2e857dbf7d3f8ff3`
  Stage A Claude ACCEPT
  `becc4b2b36f6d2ba7b2d42e580a05628f33feb74203b2e37612c0370b0523907`
  0/0; Stage A Codex ACCEPT
  `402ced3c862b05b43d758f0285fd5ad71c37cd5428879b068759a6a590e44150`
  0/0. Claude 2 Stage B turn-1 returned 5 named observations
  objects CLAUDE-D308-O1, CLAUDE-D308-O2, CLAUDE-D308-O3,
  CLAUDE-D308-O4, CLAUDE-D308-O5 (members id, observation,
  severity, where, whyItDoesNotStand); an empty mustFix list; an
  empty shouldFix list; an empty advisories list; no
  observationsNotFindings field; they travel as honesty work.
  Codex Stage B turn-1 returned an empty mustFix list; an empty
  shouldFix list; an empty advisories list; an empty observations
  list; an empty observationsNotFindings list.
- **Decision type:** RULE-GOVERNED. Records independent dual
  ACCEPT of `distribution-core-leftover-join.v10.json` (0
  blockers, 0 SHOULD-FIX). Same no-cell-edit branch as D-170
  through D-235 and D-237 through D-271 and D-273 through D-307.
  D-272 is CONTESTED and is not on that branch. Not a three-limb
  act. Not SATISFIED-GRADE.
- **Subject:**
  `docs/coop/artifacts/distribution-core-leftover-join.v10.json`
  `1de52b7675925e3ddb1b863113f019d5aec9a1eea760a85e2e857dbf7d3f8ff3`.
- **Decision:** Record distribution-core leftover-join.v10 as
  DR-101 leftover remasurement after D-307. The candidate binds
  NOTHING. DR-101 stays `OPEN`. leftover-design of OBL-2, OBL-D1,
  and OBL-D2 remains. d006UnitUndecided is false. Remainder of
  OBL-2 is (a) G02 tree-accounting UNDECIDED, so G02 size
  comparison cannot be scored, and (b) G01-G05 execution, which
  remains qualification (D-056). D-293 decided MB means 1e6 bytes
  for the D-006 G01/G02/G04 quantities; G01 and G04 size
  comparison is specified scorable on those occupancies. Does not
  invent a D-006 unit. Does not write a derived byte constant.
  Does not invent G02 tree-accounting. Does not mint Rust-as-core.
  Does not decide OD-101-1 or OD-101-2. Does not SATISFY DR-101.
  D-056 Eligibility gates 2 and 3 do not hold for DR-101. Gate 1
  Class A is not opened. Not eligible in kind. Not SATISFIED.
  Required-now stays 28. Condition-4 effect is zero. Frozen
  leftover-join.v9 remains a historical leftover remasurement
  recorded at D-287; after this successor is recorded,
  leftover-join.v9 is not current. Frozen leftover-join.v7 and
  leftover-join.v8 stay frozen; leftover-join.v8 is not recorded
  as current. Current occupancies are G01 occupancy v11, G02
  occupancy v6, G03 occupancy v5, G04 occupancy v5, G05 occupancy
  v4. Claude Stage A observationsNotFindings OBS-1, OBS-2, OBS-3,
  OBS-4 travel as honesty work. Codex Stage A leftover-join.v10
  returned no observation identifiers. Does not execute G01-G05.
  Does not occupy the G01-G05 identifiers. Does not edit file 08.
  Does not invent a D9 code. Does not authorize
  `docs/v2/implementation/`.
- **Readiness effect:** Zero SATISFIED. Condition 2 stays 5 of 32.
  Condition 4 stays MET on the naming half (28 of 28). Condition 5
