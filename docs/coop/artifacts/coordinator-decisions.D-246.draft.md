...
occupancy v4, corpus v7, and this draft unmoved,
...
leftover-join.v9. leftover-join.v4 through v10 are not
current. leftover-join.v5, leftover-join.v6, and
leftover-join.v10 are split predecessors. leftover-join.v8
is Dual REJECT 0/1 G21LJ-V8-SF1. Do not record leftover-join.v11
leftoverDesign as other than `[OBL-G21-FX-AUTHORING]`. Do not
claim CC-5 fully authored.
