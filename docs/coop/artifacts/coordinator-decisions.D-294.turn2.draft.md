...
version) at 29 sites. After D-288 through D-292 none of them is a
...
leftover-join.v5 is not current."). D-261, D-264, D-282 through
D-285, and D-287 were occupancy remasurements that refreshed their
cross-citations in passing. D-286 was both: exact-bytes leftover-join.v7's predecessor
role names two stale inputs it remasures — occupancy v3 after occupancy
v4 (D-210) and component-manifest leftover-join.v4 after
component-manifest leftover-join.v9 (D-282).
...
| packaging leftover-join.v4 | component-manifest leftover-join.v6 (D-174) | component-manifest leftover-join.v9 (D-282) | 4 | `registerRowNote`: "component-manifest leftover-join.v6 remains the current DR-103 ROW leftover-join (D-174; registerRow DR-103)." | `[OBL-WINDOWS-PATH, OBL-ENVELOPE-MISMATCH, OBL-UNICODE-NORM, OBL-OD-1, OBL-OD-2]` (identical in both) | none named — partition equality only |
| permission leftover-join.v12 | g09 leftover-join.v11 (D-257) | g09 leftover-join.v12 (D-288) | 4 | `registerRowNote`: "g09 leftover-join.v11 remains the current G09 GATE leftover-join (D-257; registerRow DR-G09)." | `[OBL-FX-AUTHORING]` (identical in both) | OBL-FX-AUTHORING (present in both, same value) |
...
1. **Reading (symmetric).** In a recorded leftover-join, a sentence
   ...
   leftover-join is leftover-join.v8 (D-240)"). A later successor of X does not, by itself, make the citing
...
3. **Refresh.** A successor issued for any reason refreshes its
   ...
   at D-250 through D-271 and D-273 through D-287 did wherever they
   carried such citations (D-272 is CONTESTED and records nothing). No frozen artifact is edited to achieve this.
