...
Turn-1 subject `coordinator-decisions.D-138.draft.md`
`46993d4711dd910fa3d677d7166626fe9e23caa21093a701b726c07171f1aa2a`
held frozen. Claude 2 OBJECT, 0 MUST-FIX, 1 SHOULD-FIX
CLAUDE-D138-SF1. Codex CONSENT, 0 MUST-FIX, 0 SHOULD-FIX.

| ID | Sev | Disposition |
|---|---|---|
| CLAUDE-D138-SF1 | SHOULD-FIX | ACCEPTED. Decision 2 now states the measurable basis: no DR-G obligation names any of NT-1..NT-8 and no owner is assigned to them. The eligibility conclusion is unchanged. |
| CLAUDE-D138-ADV-1 | advisory | VENUED-TO-DISPATCH. Dispatch/prompt pin divergence is not a subject defect. Not performed here. |
...
| Turn-1 subject (frozen) | `46993d4711dd910fa3d677d7166626fe9e23caa21093a701b726c07171f1aa2a` |
| Claude 2 turn-1 verdict | `aaf2e5027233d6180554858ac781e3aad51dae7f993e32ff7b5243ca823b8708` |
| Codex turn-1 verdict | `8c08218688fc8f4e5e37e3fe476a1d4de9469ed7bc6217d6f3a5026a51d2bbf7` |

If a cited file moves in a way that is not append-only COORD
growth with file 08, the v2 subject, both v2 verdicts, recorded
v3 (DR-133), recorded v5 (DR-117), the frozen turn-1 subject,
...
2. DR-131 stays `OPEN`. No `SATISFIED`. No `QUALIFIED`. The
   ...
   alone: NT-1..NT-8 are specified-classes-not-executed; no
   DR-G obligation names any of them and no owner is assigned
   to them, so Eligibility gates 2 and 3 are not established.
   This artifact assigns no class owners at all. A later
