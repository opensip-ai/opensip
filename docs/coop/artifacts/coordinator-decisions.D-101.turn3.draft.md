...
> edited. Frozen D-099 subjects are not edited. Not a
> fourth turn of D-099. Not a SATISFIED re-record.
...
`coordinator-decisions.D-101.turn2.draft.md`
`795c34e13e474b5007b33693d8399abb58df3910a79933ab6d927af2d922729b`
held frozen. Claude 2 OBJECT, 1 MUST-FIX D101-T2-MF-1,
1 SHOULD-FIX D101-T2-SF-1. Codex OBJECTIONS, 1 MUST-FIX
ADV-D101-T2-01. D-099 remains CONTESTED at
`90c80fc31b4c4a0dc376da62184d1fd6d82f21a4`.
The contract lives in this file's bytes.

| ID | Sev | Disposition |
|---|---|---|
| D101-T2-MF-1 | MUST-FIX | ACCEPTED. Full-file sha256 is never taken between purge and cold exec. Hash before the purge that opens each cold/warm sequence and after the sequence. `stat` (inode only) immediately before each timed launch. |
| ADV-D101-T2-01 | MUST-FIX | ACCEPTED. Same sequence. |
| D101-T2-SF-1 | SHOULD-FIX | ACCEPTED. The same split check applies on Linux and macOS. |
...
| D-101 turn-2 subject | `795c34e13e474b5007b33693d8399abb58df3910a79933ab6d927af2d922729b` |
| D-101 Claude 2 turn 2 | `03dbfdcbc8d848731a2433812aa81f99ee2d15033eafe622770370e5d5e8c710` |
| D-101 Codex turn 2 | `6f8a6d83630a1b3c3c542b4525dc1f4d2b94105ac875950ecb90977f7ce07311` |
