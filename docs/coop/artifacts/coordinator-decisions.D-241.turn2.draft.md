...
Turn-1 subject `coordinator-decisions.D-241.draft.md`
`1d568b0de2103ecb0e6951c929cf7c1fc3ee09d63013da86a75fbef48df2fd05`
held frozen. Claude 2 OBJECT, 0 MUST-FIX, 1 SHOULD-FIX
CLAUDE-D241-SF1. Codex OBJECT, 0 MUST-FIX, 1 SHOULD-FIX
CODEX-D241-SF1. Those two identifiers are one class: the
turn-1 Decision item 2 called Claude Stage A
observationsNotFindings "strings" when the frozen Stage A
verdict holds four objects.

| ID | Sev | Disposition |
|---|---|---|
| CLAUDE-D241-SF1 | SHOULD-FIX | ACCEPTED. Same class as CODEX-D241-SF1. Decision item 2 now recites four unlabeled observationsNotFindings objects, each an observation paired with a whyNotAFinding. |
| CODEX-D241-SF1 | SHOULD-FIX | ACCEPTED. Same class as CLAUDE-D241-SF1. The word strings is not used. Count four, no identifiers, and no-change standing are preserved. |
...
| Turn-1 subject | `1d568b0de2103ecb0e6951c929cf7c1fc3ee09d63013da86a75fbef48df2fd05` |
| Claude 2 turn 1 | `e7782f01a752879cd3a2c968aa160e5783a7e912f9066e6782bc05721d5faddc` |
| Codex turn 1 | `b61d59ce1b14825ed0eb03e7fdb9e2655d651c3e076bd0ac83f534229a3ce9a1` |

If a cited file moves in a way that is not append-only COORD
growth or COORD heading hygiene, with file 08, v1, both
Stage A verdicts, leftover-join.v4, occupancy v4,
leftover-join.v8, the two v1 fixture files, frozen turn-1
subject, both turn-1 OBJECT reviews, and this draft
...
1. Record
   ...
   after D-240. Lands CLAUDE-D241-SF1 and CODEX-D241-SF1 as
   one class. The candidate binds NOTHING. Both independent
   Stage A reviewers returned 0 blockers and 0 SHOULD-FIX.
   There is no predecessor G21 fixture corpus.
2. DR-G21 stays `OPEN`. leftover-design of
   ...
   four unlabeled observationsNotFindings objects, each an
