...
`coordinator-decisions.D-098.turn2.draft.md`
`1be52e83df90b1ac7c02b0937cb62f861821b517c77c45905cda0dd7f4479a1b`
held frozen. Turn-2 Claude 2 CONSENT. Turn-2 Codex
OBJECTIONS, 1 MUST-FIX ADV-D098-T2-01, 2 SHOULD-FIX
ADV-D098-T2-02 / ADV-D098-T2-03.

| ID | Sev | Disposition |
|---|---|---|
| ADV-D098-01 / 02 | MUST-FIX | ACCEPTED at turn 2. |
| ADV-D098-T2-01 | MUST-FIX | ACCEPTED. Operative G03 quantiles are D-006's five only: cold p50/p95/p99 and warm p95/p99. Warm p50 is non-operative telemetry. |
| ADV-D098-T2-02 | SHOULD-FIX | ACCEPTED. Label from `runs-on`; process arch measured; image version from Set up job / ImageVersion; storage audit-only. |
| ADV-D098-T2-03 | SHOULD-FIX | ACCEPTED. Reversibility restores exact-OS and the four D-006 runner classes. |
...
2. host arch: `uname -m`. executable arch: `file` of the
   ...
   arch: measured from the launched process (`ps`/`file`
   of `/proc/self/exe` or macOS `file` of the running
   image), not assigned from host. All three match the
   class
...
| Codex turn 2 | `e46288522c047e8949c64e30b75ca72fc00f4e3c024d4d52c8df957f673ed7e1` |
