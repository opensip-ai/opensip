# D-106 turn 2 — Record component-manifest-fixture-corpus.v6 as DR-103's accepted fixture-corpus candidate
...
`docs/coop/artifacts/coordinator-decisions.D-106.review-adversarial.claude2.json`
`06f4c34364f47aefcb2324dc1daad3b5c067485090ffa03bc4634d2bcebdd032`
(1 MUST-FIX `CLAUDE-D106-M1`). Accepted into these bytes: the
measured-inputs table now names the exact register path
`docs/v2/architecture/08-decision-and-readiness-register.md`.
`CLAUDE-D106-M1` measured
`docs/coop/architecture/08-surfaces-and-topology.md`
`f2a0f6230d655064c796d160be090793d43ef5cbd20cc4384c45106246673e67`.
That file is not the register. The register still reproduces at
`1cdcf9d4071a6c5eaa7cd7d28fac288eaced796c9ee906b6f1db0f7a4b1f95b3`
(re-measured this turn). Turn-1 Codex CONSENT
`a7c671e83e5be1489136e08233fe97cfa99fdb145e66c94930c96e4d82e5e168`
used the register path. The decision is unchanged.
...
| D-106 turn-1 Claude 2 review | `06f4c34364f47aefcb2324dc1daad3b5c067485090ffa03bc4634d2bcebdd032` OBJECT, 1 MUST-FIX CLAUDE-D106-M1 |
| D-106 turn-1 Codex review | `a7c671e83e5be1489136e08233fe97cfa99fdb145e66c94930c96e4d82e5e168` CONSENT, 0 MUST-FIX, 0 SHOULD-FIX |
...
If a cited file moves, re-measure. Both corpus verdict files and the
subject are mode 0444 at the measured digests. The register path
above is the only "file 08" this draft cites. Do not substitute
`docs/coop/architecture/08-surfaces-and-topology.md`.
...
5. Does not edit `docs/v2/architecture/08-decision-and-readiness-register.md`
   (MF-6). No freeze motion. No blueprint. Does not authorize
...
- Adopt CLAUDE-D106-M1 as a live register-digest change. Rejected:
  the MUST-FIX measured the wrong path.
