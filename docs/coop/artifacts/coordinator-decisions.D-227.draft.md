...
> D-170 through D-226. Not a three-limb act. Not a
> required-now successor.
> This is coordinator decision **D-227**, not a register
> row.
...
> **Does not** execute NT-6 by existing.
> **Does not** reopen leftover-design of DR-131 NT-6 as an
> unnamed remainder.
> **Does not** take over G21 DR-133 NT-6.
> **Does not** invent a sealed-Run class.
> **Does not** take over G19.
> **Does not** treat naming v6 as naming G27.
...
> G16, G18, G19, G20, G21, G22, G23, G24, G25, G26, G31,
> or G32.
> **Does not** rewrite frozen G27 v1.
...
D-226 is ADOPTED at
`7d12d3c0c6a635354c9dba790ecc5f209fcaf4b1`.
HEAD is `7d12d3c0c6a635354c9dba790ecc5f209fcaf4b1`.
Last live heading is D-226. Required-now is 28.
...
|---|---|---|---|
| Claude 2 | `docs/coop/artifacts/harness.DR-G27.preview-analyze-not-sealed-run.preview.v2.review-independent.claude2.json` | `ad85731a624e696e0a4bf3492884a3cc152faa88ad03a886bf5ad68501a724fb` | ACCEPT 0/0 |
| Codex | `docs/coop/artifacts/harness.DR-G27.preview-analyze-not-sealed-run.preview.v2.review-independent.codex.json` | `2f43e047a1ce6dd5baf873b0c2d1113704a56b9f05c2b0be00f12d03c1b9985e` | ACCEPT 0/0 |
...
| harness.DR-G27.preview-analyze-not-sealed-run.preview.v2.review-independent.claude2.json | `ad85731a624e696e0a4bf3492884a3cc152faa88ad03a886bf5ad68501a724fb` |
| harness.DR-G27.preview-analyze-not-sealed-run.preview.v2.review-independent.codex.json | `2f43e047a1ce6dd5baf873b0c2d1113704a56b9f05c2b0be00f12d03c1b9985e` |
| COORDINATOR-DECISIONS.md | `b196e361560ff35c8c9f83f9f21a930dda1978fb1bc60570c4035b37dca9228b` |
| file 08 | `f909ddff7f3a8e9be864259808c4a2320170181001bdb746814b07393dd9d5e1` |
| HEAD | `7d12d3c0c6a635354c9dba790ecc5f209fcaf4b1` |
| Frozen v1 (historical occupancy at HEAD `5d5d778` / required-now 26, not this subject) | `783b4348b563f29989d2752eaba0f71c65e5e2c31764eb3f94a4ed599210ea0a` |
...
carries G27 (D-153). Frozen v1 remains a historical occupancy
as of HEAD `5d5d778` / required-now 26. Naming parent is
D-153 dual CONSENT, not naming v6.
...
file 08 cardinality 28, g27 leftover-join.v3 (D-202) is the
current G27 leftover-join. leftover-join.v3 leftoverDesign
remains `[OBL-G27-FX-AUTHORING]`. Current INPUT basis as
measured by leftover-join.v3 is g27-input-corpus.v1. Dual
...
1. Record
   `harness.DR-G27.preview-analyze-not-sealed-run.preview.v2.json`
   as G27 occupancy remasurement after D-226. The candidate
...
2. DR-G27 stays `OPEN`. leftover-design of OBL-G27-HARNESS-SPEC,
...
4. Claude Stage A returned seven unlabeled
...
C-D227. Does not unwrite D-167, D-168, D-169, D-170,
...
D-219, D-220, D-221, D-222, D-223, D-224, D-225, or D-226.
