# D-051 / D-052 / D-053 — Select Route B for DR-006, DR-007, DR-009
...
Turn-1 C2-D051-053-SF1 accepted (status under review).
Turn-2 C2-D051-053-T2-SF1 / Codex SHOULD-FIX accepted: protocol is turn 3 of 3.

Measured inputs at authoring:

| Path | sha256 |
|---|---|
| COORD | `827c7deff099b7dffe739cb5dfe72fb2213d740b4bcf9234ba02199da26f4bb2` |
| file 08 | `6547e6ace2ae61e664af0f65059b66c2cb3d0539d64f6687aba04f8f54dc4cd7` |

These three rows are the remaining inherited V1 prerequisites with no Route B
selection. DR-002/003/004/005/008 already have preview Route B selections.
DR-001 is SATISFIED. DR-010 is Route C with DR-117. DR-011 residuals follow
their owning surfaces.

D-002 already named the consequence of scoped disposition on these rows:
if a named condition-1 closure lands by scoped disposition rather than
binding recipes, the dependent feature ships reduced, re-scoped, or waits.
This draft selects that path for preview scope only. It does not hide the
rides.

## D-051 — Select Route B for DR-006 (preview scope)
...
2. This selection is one row. It does not select DR-002, DR-003,
   DR-004, DR-005, DR-007, DR-008, or DR-009.
...
supersession. Overturn: C-D051.

## D-052 — Select Route B for DR-007 (preview scope)
...
2. This selection is one row. It does not select DR-002, DR-003,
   DR-004, DR-005, DR-006, DR-008, or DR-009.
...
Total before any dependent disposition lands. After one lands,
overturn also requires that disposition's owning-authority
supersession. Overturn: C-D052.

## D-053 — Select Route B for DR-009 (preview scope)
