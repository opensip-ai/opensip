...
> **Date:** 2026-08-28
> **Protocol:** D-000 new cycle, turn 3 of 3. Turn 2 landed CLAUDE-D294-SF1 (grammar widened, measurement rule), CLAUDE-D294-SF2 (Decision 1, whichever kind), CLAUDE-D294-SF3 (Decision 2(a) and 3 ranges), CODEX-D294-MF1 (Decision 2(b), one trigger), CODEX-D294-MF2 (D-272 excluded from Decision 3), CODEX-D294-SF1 (D-286 mixed trigger, rationale), and CODEX-D294-SF2 (currentness sentence, measured inputs). This turn lands CLAUDE-D294-T2-SF1 and CODEX-D294-T2-SF1 (the site count and the Sites column recomputed under the widened grammar, measured inputs), CLAUDE-D294-T2-SF2 (this Protocol line names every identifier), and CODEX-D294-T2-SF2 (D-287 has no cross-lineage citation to refresh, rationale). All identifiers are named; none was rejected.
...
version) at 35 sites. After D-288 through D-292 none of them is a
...
|---|---|---|---|---|---|---|
| component-manifest leftover-join.v9 | g15 leftover-join.v5 (D-270) | g15 leftover-join.v6 (D-290) | 4 | `registerRowNote`: "g15 leftover-join.v5 remains the current G15 GATE leftover-join (D-270; registerRow DR-G15)." | `[OBL-AT-FX-AUTHORING]` (identical in both) | OBL-ADAPTER-IMPL (absent in both), OBL-AT-FX-AUTHORING (present in both, same value) |
| doctor-actor leftover-join.v12 | g12 leftover-join.v4 (D-258) | g12 leftover-join.v5 (D-289) | 4 | `registerRowNote`: "g12 leftover-join.v4 remains the current G12 GATE leftover-join (D-258; registerRow DR-G12)." | `[OBL-DOCTOR-FX-AUTHORING]` (identical in both) | OBL-DOCTOR-FX-AUTHORING (present in both, same value) |
| doctor-actor leftover-join.v12 | g21 leftover-join.v12 (D-248) | g21 leftover-join.v13 (D-292) | 4 | `registerRowNote`: "g21 leftover-join.v12 remains the current G21 GATE leftover-join (D-248; registerRow DR-G21)." | `[OBL-G21-FX-AUTHORING]` (identical in both) | OBL-G21-FX-AUTHORING (present in both, same value) |
...
| packaging leftover-join.v4 | component-manifest leftover-join.v6 (D-174) | component-manifest leftover-join.v9 (D-282) | 5 | `registerRowNote`: "component-manifest leftover-join.v6 remains the current DR-103 ROW leftover-join (D-174; registerRow DR-103)." | `[OBL-WINDOWS-PATH, OBL-ENVELOPE-MISMATCH, OBL-UNICODE-NORM, OBL-OD-1, OBL-OD-2]` (identical in both) | none named — partition equality only |
...
| permission leftover-join.v12 | doctor-actor leftover-join.v11 (D-170) | doctor-actor leftover-join.v12 (D-285) | 3 | `registerRowNote`: "doctor-actor leftover-join.v11 remains the current DR-114 ROW leftover-join (D-170; registerRow DR-114)." | `[OBL-DOCTOR-FX-AUTHORING, OBL-JOIN-FX-AUTHORING, OBL-FC-C1, OBL-BLK-1, OBL-BLK-2, OBL-BLK-3, OBL-BLK-4]` (identical in both) | none named — partition equality only |
...
| state-class leftover-join.v4 | g19 leftover-join.v4 (D-256) | g19 leftover-join.v5 (D-291) | 5 | `registerRowNote`: "g19 leftover-join.v4 remains the current G19 GATE leftover-join (D-256; registerRow DR-G19)." | `[OBL-G19-FX-AUTHORING]` (identical in both) | OBL-G19-FX-AUTHORING (present in both, same value) |
