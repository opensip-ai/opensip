...
> D-170 through D-196. Not a three-limb act. Not a
> required-now successor.
> This is coordinator decision **D-197**, not a register
> row.
...
> **Does not** invent fixture bytes, populate reserved TCB
> tables, or invent Rosetta.
...
D-196 is ADOPTED at
`cfc778cbaffcc6cb54e14035810d9d1f6f4d605a`.
HEAD is `cfc778cbaffcc6cb54e14035810d9d1f6f4d605a`.
Last live heading is D-196. Required-now is 28.
...
|---|---|---|---|
| Claude 2 | `docs/coop/artifacts/g22-leftover-join.v3.review-independent.claude2.json` | `f960cfdf9ecb598aefdf2c62e58e44d0dd393b288e0c0601a9b4353c20d38c82` | ACCEPT 0/0 |
| Codex | `docs/coop/artifacts/g22-leftover-join.v3.review-independent.codex.json` | `e8993a247722816716e32f4d571783c11ef2ed91a9eed315eae10433e6c34ee6` | ACCEPT 0/0 |

Measured inputs:

| Path | sha256 |
|---|---|
| g22-leftover-join.v3.json | `b251605c06dbbeaa0c791ec4874c5b394b186f1858515e9a8af6cc10401bdbbb` |
| g22-leftover-join.v3.review-independent.claude2.json | `f960cfdf9ecb598aefdf2c62e58e44d0dd393b288e0c0601a9b4353c20d38c82` |
| g22-leftover-join.v3.review-independent.codex.json | `e8993a247722816716e32f4d571783c11ef2ed91a9eed315eae10433e6c34ee6` |
| COORDINATOR-DECISIONS.md | `720779ac1a30c7a22fce39933ba06b08fc444a5324d27349120f39dd4a9d1963` |
| file 08 | `f909ddff7f3a8e9be864259808c4a2320170181001bdb746814b07393dd9d5e1` |
| HEAD | `cfc778cbaffcc6cb54e14035810d9d1f6f4d605a` |
| Frozen v2 (historical, not this subject) | `2a66c1c60fb38b8600675137ba6a14a70787f2a028cf349d3ad015c0dc7028ea` |
...
platform-tcb leftover-join.v6 (D-185) as the current DR-126
ROW leftover-join, and replaces D-167 placeholder
sentences with carry-safe phrasing. leftover-design of
OBL-G22-FX-AUTHORING remains. Dual independent ACCEPT
...
1. Record `g22-leftover-join.v3.json` as G22 leftover
   remasurement after D-196. The candidate binds NOTHING.
...
2. DR-G22 stays `OPEN`. leftover-design of
   OBL-G22-FX-AUTHORING remains. G22 harness specification
   is measured authored and not QUALIFIED. Not QUALIFIED.
3. Does not SATISFY DR-126. Does not steal
   OBL-RESERVED-TABLES. Gate 1 Class A is not opened. Not
   SATISFIED.
4. Required-now stays 28. Condition-4 effect is zero.
   Condition 4 stays MET at 28 of 28 / 32 of 32.
5. Does not invent fixture bytes, populate reserved TCB
   tables, or invent Rosetta. Does not rewrite G22, G31,
   or G32. Does not edit file 08. Does not invent a D9
...
C-D197. Does not unwrite D-167, D-168, D-169, D-170,
