...
Turn-1 subject `coordinator-decisions.D-208.draft.md`
`0fdea9aa1c2e01ba9fc1c7923139fd77aadd5ab403c2d9b48202a8621646efd6`
held frozen. Claude 2 OBJECT, 0 MUST-FIX, 2 SHOULD-FIX
CLAUDE-D208-SF1 / CLAUDE-D208-SF2. Codex OBJECT, 0 MUST-FIX,
1 SHOULD-FIX CODEX-D208-SF1.

| ID | Sev | Disposition |
|---|---|---|
| CLAUDE-D208-SF1 | SHOULD-FIX | ACCEPTED. Decision item 4 names all four Stage A advisories. CLAUDE-G31-V5-ADV-2 / CODEX-G31-V5-ADV-1 are one shared class and both identifiers are preserved. |
| CODEX-D208-SF1 | SHOULD-FIX | ACCEPTED. Same repair as CLAUDE-D208-SF1. |
| CLAUDE-D208-SF2 | SHOULD-FIX | ACCEPTED. Measured-inputs table pins frozen v3 at `68cccfcd…` between v2 and v4. |
...
| Frozen v3 (dual REJECT, not this subject) | `68cccfcd0d736d87354097d574c0d9c14154ba9b8deb07c68f62d6a846998c80` |
| Frozen v4 (dual REJECT, not this subject) | `af23c1b29c956d9941541d4eb337542700ad9e91300348295df5bf61f81bf272` |
| Turn-1 subject | `0fdea9aa1c2e01ba9fc1c7923139fd77aadd5ab403c2d9b48202a8621646efd6` |
| Claude 2 turn 1 | `f64e81fd0f18c0fdd24e2541e2a7d806a6213632b149c9ef6f641e88344a7d60` |
| Codex turn 1 | `2412b49511ef027d462abb759b19c2d39d9956bca9850f7c0bb62e394a391c25` |

If a cited file moves in a way that is not append-only COORD
growth or COORD heading hygiene, with file 08, v5, both
Stage A verdicts, frozen v2/v3/v4, and this draft unmoved,
...
4. Advisories CLAUDE-G31-V5-ADV-1, CLAUDE-G31-V5-ADV-2 /
   CODEX-G31-V5-ADV-1 (one shared advisory class; both
   identifiers preserved), and CLAUDE-G31-V5-ADV-3 travel as
   honesty work. Does not execute the eleven classes. Does
   not invent fixture bytes. Does not rewrite G31 or G32.
