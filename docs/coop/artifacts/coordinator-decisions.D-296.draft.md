...
|---|---|---|
| Claude | OBS-1, OBS-2, OBS-3, OBS-4, OBS-5 | Claude Stage A sarif-fc-nonauth-term-golden.v3 returned 5 named observations objects (with members detail, id, note, title, whyNotCharged) OBS-1, OBS-2, OBS-3, OBS-4, OBS-5; no observationsNotFindings field; no advisories field |
...
This entry names the Claude identifiers OBS-1, OBS-2, OBS-3, OBS-4, OBS-5; no identifier is invented.
