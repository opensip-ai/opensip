...
Stage A verdicts, frozen v1/v2/v3/v4, and this draft unmoved,
...
4. Claude Stage A returned zero advisories. Codex Stage A
   ...
   shared class with Claude Stage A notRaised naming-v6
   path standing; both identifiers are preserved. CLAUDE-G16-V3-MF1,
