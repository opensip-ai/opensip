# Independent review — preview-product-boundary-successor.v10

Independent, refute not confirm.

**SUBJECT:** `docs/coop/artifacts/preview-product-boundary-successor.v10.json`
Expected sha256:
`8f34c92ef4fb835ce31945bfc73e1442b38dada1d483380231a53d1d93a03483`
Mode 0444. If the subject moves, OBJECT / REJECT.

preview-product-boundary-successor.v8 (`f2e788e51c347e1033073f0718e701d164affe51e7f667da9bcd49a08837144c`, D-207) remains frozen and remains the current recorded DR-117 leftover remasurement until a coordinator act records this subject. preview-product-boundary-successor.v9 (`e0221a1c095f688dcd5b127bce9f712543165599c71dc8415b94fb7bfdea4dd5`) was REJECTED at Stage A by both reviewers and is unrecorded; it remains frozen; do not treat it as this subject; check that this subject lands every finding of both v9 reviews (their ids are named in the subject's findingDisposition). Do not treat preview-product-boundary-successor.v8 as this subject. product-boundary-successor-contract.v8 (`52c70f7715fb869bae70bc588043dc5b4d731b73408d2d451e868b8de963f362`, D-116) is a distinct lineage; do not treat it as this subject either.

**WRITE ONLY:**
- Claude 2: `docs/coop/artifacts/preview-product-boundary-successor.v10.review-independent.claude2.json`
- Codex: `docs/coop/artifacts/preview-product-boundary-successor.v10.review-independent.codex.json`
...
HEAD is `f3456575071928022a1f0e3a77e531a87157b365` (D-294 ADOPTED). Last heading is D-294. Required-now is 28.
Live COORD sha256 is `31746810f9be78f697d66eb94d9cd50a95a51218998f97a154596363039fb9b6`; file 08 sha256 is `e503b75b5599444ee4d77c0c7d7c82a74026b2c1848ad214e0ac738c0aa40c3e`.
...
- `docs/coop/artifacts/g29-leftover-join.v4.json` `9e1af4ba3b21e483154825fa2c6d275f7ee805d1fb455f01c9d35e48411c3f64` (D-254)
- `docs/coop/artifacts/g30-leftover-join.v4.json` `3f3d84e0e24a2aea0ba95c282f809c8343d1827d0577ca8396d4560c5e012c75` (D-255)
- `docs/coop/artifacts/g09-leftover-join.v12.json` `fc96ba91080ccef81259c6eb5ac004303a2b919e922d4bb54a448e26d149727c` (D-288)
- `docs/coop/artifacts/language-runtime-leftover-join.v7.json` `90e29696f0b3ed2b23c3a5f1d7c089d54aef6887e6f3a8d9d9dfe988282fb4e3` (D-274)
- `docs/coop/artifacts/g16-leftover-join.v5.json` `7ce75ea514322a6e17546ec8e9b91c4fb2f66128271d6c6d757e3f627e05ab78` (D-278)
- `docs/coop/artifacts/g21-leftover-join.v13.json` `058717f51ee62e85fa3094e9a65c207fb78a7f706e57a35a854f1a9a55ecc66e` (D-292)
- `docs/coop/artifacts/g23-leftover-join.v8.json` `498324e5e456562317c7681b44cdac9138ca1e947aa363dad5a331caa3eef812` (D-240)
- `docs/coop/artifacts/permission-leftover-join.v12.json` `496b75c60c6540c3272c2c57d86c43ca71a77a1ed2eceaa6e3a1c49251374fb3` (D-283)
- `docs/coop/artifacts/distribution-core-leftover-join.v9.json` `e6b235d3330a03e62acede6770919a413791c958a3e791eca5f677e822100bc7` (D-287)
- `docs/coop/artifacts/monorepo-leftover-join.v4.json` `03d4478c3ce6ea843f8a4ee3ea1dcc6d8c06bd661f71970fe836ce107b611481` (D-277)
- `docs/coop/artifacts/language-quality-leftover-join.v5.json` `e12101736f9a320a06a3311f405981801fad73c42ba9b7537f506e6c4859bd53` (D-273)
- `docs/coop/artifacts/doctor-actor-leftover-join.v12.json` `0c0b894ffb5f80981282455a99153975e3fac30ade076d2596efb2b4fcf1a9e9` (D-285)
