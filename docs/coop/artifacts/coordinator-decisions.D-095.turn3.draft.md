...
Turn-1 subject `coordinator-decisions.D-095.draft.md`
`dbf703babfef20a6e1e89857c74b8525846a6f2d658a646a6a3191b6acd9dd15`
held frozen. Turn-2 subject
`coordinator-decisions.D-095.turn2.draft.md`
`3083cd2b9014266fc3a07c9f389e8f8f499a0d6199b953df450d3415ff78565a`
held frozen. Claude 2 CONSENT both turns. Codex turn 2
OBJECTIONS, 1 MUST-FIX ADV-D095-T2-01, 1 SHOULD-FIX
ADV-D095-T2-02.

| ID | Sev | Disposition |
|---|---|---|
| ADV-D095-T2-01 | MUST-FIX | ACCEPTED. D-054 / D-057 are condition-1 V1 Route-B owner machinery. They do not authorize owner-recording of these condition-2 deferrals. This act is coordinator recording only. Owner-recording is blocked until an applicable grant and mechanics are adopted. DR-116 is Route C. |
| ADV-D095-T2-02 | SHOULD-FIX | ACCEPTED. Owner-recording precedes a separate later D-000-reviewed MF-6. Neither occurs in this entry. |
...
D-094 is CONTESTED, not adopted. G03/G04 stay reserved.
This entry does not retry D-094.

## Decision

1. Record the five v2 artifacts as the accepted
   architecture-preview explicit-deferral **candidates**
   D-001 / D-002 require to exist. This is the coordinator
   recording only.
...
3. This entry does not make the coordinator those owners.
   ...
   Windows platform set) is **blocked** until an applicable
   authority and mechanics are adopted — either a reviewed
   user amendment covering the named security / platform /
   release / evidence / storage / product / architecture
   roles, or a D-000-reviewed mechanics entry that is not
   D-057's V1 Route-B file. DR-116 remains Route C.
...
5. Do not edit file 08. Do not change condition-2
   SATISFIED counts. Owner-recording, when later authorized,
   precedes a **separate** later D-000-reviewed MF-6.
   Neither owner-recording nor MF-6 occurs in this entry.
...
- Edit file 08 in this entry. Rejected: D-042 class;
  owner-recording precedes a separate later D-000-reviewed
  MF-6; neither occurs in this entry.
- Cite D-054 / D-057 as the later owner grant. Rejected:
  ADV-D095-T2-01; those entries are condition-1 V1 Route B.
- Pretend the coordinator is the named owner. Rejected:
  D-000 does not silently make the coordinator every
  security / release / evidence / platform owner.
...
- Quote truncated verdict digests. Rejected: D091-SF-2
  class.
- Retry D-094 here. Rejected: parked CONTESTED; new cycle
  only.
...
applicable owner recording lands **and** a separate later
MF-6 records the disposition in file 08. Condition 4 stays
16 of 18 PARTLY MET. Condition 5 remains last.

## Reversibility

C-D095. Does not overturn D-002, D-054, D-057, D-093, or
D-094's CONTESTED parking.

## Measured inputs at turn-3 dispatch

| Path | sha256 |
|---|---|
| COORD | `d6d152fde0b754be97918ab723f9a750949495b2942539040c010d72e05ad60b` |
...
| turn-1 subject | `dbf703babfef20a6e1e89857c74b8525846a6f2d658a646a6a3191b6acd9dd15` |
| turn-2 subject | `3083cd2b9014266fc3a07c9f389e8f8f499a0d6199b953df450d3415ff78565a` |
| Claude 2 turn 1 | `25c3119d9e8197a8aa24b02379e395d90bc9bea762353b56dda14a0ded0188ff` |
| Claude 2 turn 2 | `b6539bd049203d3302f8f3416f859771fb3f794258d8362973e6aada959c4bd7` |
| Codex turn 2 | `1967128d94ab32902a0ef39c9619d458430babf9ef7ee586fae43cfaac006245` |
